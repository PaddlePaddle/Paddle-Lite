...
if((LITE_WITH_OPENCL AND (ARM_TARGET_LANG STREQUAL "clang")) OR LITE_WITH_PYTHON OR LITE_WITH_EXCEPTION)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fexceptions -fasynchronous-unwind-tables -funwind-tables")
endif()
if (LITE_ON_TINY_PUBLISH)
    if(NOT (LITE_WITH_OPENCL AND (ARM_TARGET_LANG STREQUAL "clang")) AND (NOT LITE_WITH_PYTHON) AND (NOT LITE_WITH_EXCEPTION))

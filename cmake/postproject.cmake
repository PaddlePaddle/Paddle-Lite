            ...
            if(${ANDROID_NDK_MAJOR} GREATER "17")
                ...
                elseif(${ARM_TARGET_ARCH_ABI} STREQUAL "armv7")
                  if(${ANDROID_NDK_MAJOR} GREATER "21")
                    set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -march=armv8.2-a+fp16+nolse -mfpu=neon-fp-armv8 -mfloat-abi=softfp")
                    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv8.2-a+fp16+nolse -mfpu=neon-fp-armv8 -mfloat-abi=softfp")
                  else()
...
if(ARMLINUX)
    ...
    if(ARMLINUX_ARCH_ABI STREQUAL "armv7")
        ...
        if (LITE_WITH_ARM82_FP16)
          set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv8.2-a+fp16+nolse -mfpu=neon-fp-armv8")
          set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -march=armv8.2-a+fp16+nolse -mfpu=neon-fp-armv8")
        endif()
    endif()

      ...
      if(WITH_MKL)
        if(WITH_STATIC_MKL)
          ...
          if("${cc_library_DEPS};" MATCHES "mklml;")
            ...
            if(NOT "${TARGET_NAME}" MATCHES "x86_math")
              list(APPEND cc_library_DEPS x86_math)
            endif()
...
function(raw_cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    if(LITE_WITH_LIGHT_WEIGHT_FRAMEWORK)
      target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} ${os_dependency_modules} core_tester gtest gflags logging)
      add_dependencies(${TARGET_NAME} ${cc_test_DEPS} core_tester gtest gflags logging)
    else()

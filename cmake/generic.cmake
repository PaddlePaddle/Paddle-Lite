...
function(raw_cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    if(LITE_WITH_LIGHT_WEIGHT_FRAMEWORK)
      target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} ${os_dependency_modules} lite_gtest_main gtest gflags utils)
      add_dependencies(${TARGET_NAME} ${cc_test_DEPS} lite_gtest_main gtest gflags utils)
    else()

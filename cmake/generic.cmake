...
function(raw_cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    if(LITE_WITH_LIGHT_WEIGHT_FRAMEWORK)
      target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} ${os_dependency_modules} core gtest gflags logging)
      add_dependencies(${TARGET_NAME} ${cc_test_DEPS} core gtest gflags logging)
    else()
      target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} ${os_dependency_modules} core gtest gflags glog)
      add_dependencies(${TARGET_NAME} ${cc_test_DEPS} core gtest gflags glog)

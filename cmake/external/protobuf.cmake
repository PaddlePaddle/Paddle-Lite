...
FUNCTION(build_protobuf TARGET_NAME BUILD_FOR_HOST)
    ...
    SET(X86_LITE_WITH_LIGHT_WEIGHT_FRAMEWORK ${LITE_WITH_LIGHT_WEIGHT_FRAMEWORK})
    IF (LITE_WITH_LIGHT_WEIGHT_FRAMEWORK AND LITE_WITH_X86)
      SET(X86_LITE_WITH_LIGHT_WEIGHT_FRAMEWORK OFF)
    ENDIF()


    IF(BUILD_FOR_HOST)
        # set for server compile.
        if (NOT X86_LITE_WITH_LIGHT_WEIGHT_FRAMEWORK)
    ...
    if(X86_LITE_WITH_LIGHT_WEIGHT_FRAMEWORK)
        ExternalProject_Add(
            ${TARGET_NAME}

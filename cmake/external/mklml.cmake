...
IF(WITH_STATIC_MKL)
    ...
    IF(WIN32)
        SET(MKLML_VER "mklml_win_${TIME_VERSION}_static" CACHE STRING "" FORCE)
...
IF(WITH_STATIC_MKL)
    ...
    SET(MKLML_LIBRARIES mklml_core mklml_intel_lp64 mklml_intel_thread CACHE INTERNAL "Intel(R) MKLML Libraries")

...
if (MSVC)
  ...
  set(SUB_PATH "XTCL")
  message(STATUS "SUB_PATH:${SUB_PATH}")
  file(GLOB  DIRECTORY_MATCHES "${XPU_SDK_ROOT}/${SUB_PATH}")
  if(DIRECTORY_MATCHES)
    message(STATUS "Macth Path:${DIRECTORY_MATCHES}")
    set (XPU_INCLUDE_DIR "${XPU_SDK_ROOT}/XTCL/include" CACHE PATH "xpu include directory" FORCE)

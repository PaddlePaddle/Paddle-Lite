...
namespace paddle_mobile{
    namespace operators{
        ...
        bool NearestInterpolationKernel<GPU_CL, float >::Init(
                paddle_mobile::operators::NearestInterpolationParam<paddle_mobile::GPU_CL> *param) {
        ...
        void NearestInterpolationKernel<GPU_CL, float >::Compute(
                const paddle_mobile::operators::NearestInterpolationParam<paddle_mobile::GPU_CL> &param) {

...
namespace paddle_mobile {
    namespace operators {
        template<>
        bool SliceKernel<GPU_CL, float>::Init(paddle_mobile::operators::SliceParam<paddle_mobile::GPU_CL> *param) {
        ...
        void SliceKernel<GPU_CL, float>::Compute(
            ...
            int axes_0 = param.axes_[0] - (param.original_output_dims_size_ - param.output_->dims().size());

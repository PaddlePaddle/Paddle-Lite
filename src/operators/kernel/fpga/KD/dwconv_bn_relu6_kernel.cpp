...
template <>
bool DWConvBNRelu6Kernel<FPGA, float>::Init(
  ...
  depthwise_conv_param.activeParam.type = zynqmp::TYPE_RELU6;
  std::cout << "DWConvBNRelu6Kernel:" << depthwise_conv_param.activeParam.type << std::endl;
...
template <>
void DWConvBNRelu6Kernel<FPGA, float>::Compute(

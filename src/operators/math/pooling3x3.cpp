...
inline void Pooling3x3NormalRow(const float *input, const int h_output,
                                ...
                                const int output_w, const bool exclusive, float *output) {
  ...
  float32x4_t post = exclusive ? vdupq_n_f32(1.f / (3 * (h_end - h_start))) : vdupq_n_f32(1.f / 9);
          ...
          if (padding_w) {
            ...
            for (int w = valid_w_start - 1; w >= 0; --w) {
              ...
              if (padding >= 3) {
                ...
                post = exclusive ? vdup_n_f32(1.f / (3 * (3 - padding))) : vdup_n_f32(1.f / 9);

...
void conv_depthwise_3x3p0(const float *din, float *dout, int num, int ch_out,
  ...
  if (stride == 1) {
    if (flag_relu) {
      ...
      if (w_in > 5) {
        conv_depthwise_3x3s1p0_bias(dout, din, weights, bias, flag_bias, num,
                                    ch_in, h_in, w_in, h_out, w_out);
      } else {
        conv_depthwise_3x3s1p0_bias_s(dout, din, weights, bias, flag_bias, num,
                                      ch_in, h_in, w_in, h_out, w_out);
      }
    }
  } else {  //! stride = 2
    if (flag_relu) {
      ...
      if (w_in > 8) {
        conv_depthwise_3x3s2p0_bias(dout, din, weights, bias, flag_bias, num,
                                    ch_in, h_in, w_in, h_out, w_out);
      } else {
        conv_depthwise_3x3s2p0_bias_s(dout, din, weights, bias, flag_bias, num,
                                      ch_in, h_in, w_in, h_out, w_out);
      }
    }
  }
      ...
      for (int i = 0; i < h_out; i += 2) {
        ...
        asm volatile(
            ...
            : [wr0] "w"(wr0), [wr1] "w"(wr1), [wr2] "w"(wr2),
              [bias_val] "r"(bias_val), [vzero] "w"(vzero), [remain] "r"(remain)
      ...
      for (int j = 0; j < h_out; j += 2) {
        ...
        asm volatile(
            ...
            : [wr0] "w"(wr0), [wr1] "w"(wr1), [wr2] "w"(wr2),
              ...
              [mask2] "w"(vmask_rp2), [zero] "w"(vzero), [out1] "r"(out_buf1),
              [out2] "r"(out_buf2)
            : "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7",
      ...
      for (int j = 0; j < h_out; ++j) {
        ...
        asm volatile(
            ...
            : [din0_ptr] "+r"(din0_ptr), [din1_ptr] "+r"(din1_ptr),
              [din2_ptr] "+r"(din2_ptr)
            : [wr0] "w"(wr0), [wr1] "w"(wr1), [wr2] "w"(wr2),
              [bias] "r"(bias_c), [out] "r"(out_buf), [mask_ptr] "r"(dmask)
            : "cc", "memory", "q3", "q4", "q5", "q6", "q7", "q8", "q9", "q10",
              "q11", "q12", "q13", "q14", "q15");
#endif  //__aarch64__
        for (int w = 0; w < w_out; ++w) {
      ...
      for (int j = 0; j < h_out; ++j) {
        ...
        asm volatile(
            ...
            : [din0_ptr] "+r"(din0_ptr), [din1_ptr] "+r"(din1_ptr),
              [din2_ptr] "+r"(din2_ptr)
            : [wr0] "w"(wr0), [wr1] "w"(wr1), [wr2] "w"(wr2), [bias] "w"(vbias),
              [out] "r"(out_buf), [mask_ptr] "r"(mask_ptr)
            : "cc", "memory", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11",
              "v12", "v13", "v14", "v15", "v16");
        ...
        asm volatile(
            ...
            : [din0_ptr] "+r"(din0_ptr), [din1_ptr] "+r"(din1_ptr),
              [din2_ptr] "+r"(din2_ptr)
            : [wr0] "w"(wr0), [wr1] "w"(wr1), [wr2] "w"(wr2),
              [bias] "r"(bias_c), [out] "r"(out_buf), [mask_ptr] "r"(mask_ptr)
            : "cc", "memory", "q3", "q4", "q5", "q6", "q7", "q8", "q9", "q10",
              "q11", "q12", "q13", "q14", "q15");
#endif  //__aarch64__
        for (int w = 0; w < w_out; ++w) {

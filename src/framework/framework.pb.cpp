...
void TableStruct::InitDefaultsImpl() {
    ...
    _VarDesc_default_instance_._instance.get_mutable()->type_ =
        const_cast<::paddle_mobile::framework::proto::VarType *>(
    ...
    for (;;) {
            ...
            if (static_cast<::google::protobuf::uint8>(tag) ==
                ...
                DO_((
                    ::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                        int, ::google::protobuf::internal::WireFormatLite::
                                 TYPE_ENUM>(input, &value)));
                if (::paddle_mobile::framework::proto::AttrType_IsValid(
                        value)) {
        ...
        case 4: {
            if (static_cast<::google::protobuf::uint8>(tag) ==
                ...
                DO_((
                    ::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                        float, ::google::protobuf::internal::WireFormatLite::
                                   TYPE_FLOAT>(input, &f_)));
            } else {
                goto handle_unusual;
            }
        ...
        case 6: {
            if (static_cast<::google::protobuf::uint8>(tag) ==
                ...
                DO_((::google::protobuf::internal::WireFormatLite::
                         ReadRepeatedPrimitive<::google::protobuf::int32,
                ...
                DO_((::google::protobuf::internal::WireFormatLite::
                         ReadPackedPrimitiveNoInline<
                             ::google::protobuf::int32,
                             ::google::protobuf::internal::WireFormatLite::
                                 TYPE_INT32>(input, this->mutable_ints())));
            } else {
                goto handle_unusual;
            }
            break;
...
void OpDesc_Attr::set_strings(int index, const char *value, size_t size) {
    strings_.Mutable(index)->assign(reinterpret_cast<const char *>(value),
                                    size);
...
size_t OpDesc::ByteSizeLong() const {
    ...
    // 1;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->inputs(static_cast<int>(i)));
        }
    }
    ...
    // 2;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->outputs(static_cast<int>(i)));
        }
    }
    ...
    // 4;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->attrs(static_cast<int>(i)));
        }
    }
    ...
    for (;;) {
        ...
        case 2: {
            if (static_cast<::google::protobuf::uint8>(tag) ==
                static_cast<::google::protobuf::uint8>(16u /* 16 & 0xFF */)) {
                DO_((::google::protobuf::internal::WireFormatLite::
                         ReadRepeatedPrimitive<::google::protobuf::int64,
                                               ::google::protobuf::internal::
                ...
                DO_((::google::protobuf::internal::WireFormatLite::
                         ReadPackedPrimitiveNoInline<
                             ::google::protobuf::int64,
                             ::google::protobuf::internal::WireFormatLite::
                                 TYPE_INT64>(input, this->mutable_dims())));
            } else {
                goto handle_unusual;
            }
            break;
...
size_t VarType_ReaderDesc::ByteSizeLong() const {
    ...
    // 1;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->lod_tensor(static_cast<int>(i)));
        }
    }
...
void VarType::Clear() {
    ...
    if (cached_has_bits & 63u) {
        ...
        if (cached_has_bits & 0x00000008u) {
            ...
            reader_->::paddle_mobile::framework::proto::VarType_ReaderDesc::
                Clear();
        }
        if (cached_has_bits & 0x00000010u) {
            GOOGLE_DCHECK(channel_ != NULL);
            channel_->::paddle_mobile::framework::proto::VarType_ChannelDesc::
                Clear();
        }
        if (cached_has_bits & 0x00000020u) {
...
size_t VarType::ByteSizeLong() const {
    ...
    if (_has_bits_[0 / 32] & 63u) {
        ...
        if (has_selected_rows()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::
...
void VarType::MergeFrom(const VarType &from) {
    ...
    if (cached_has_bits & 127u) {
        if (cached_has_bits & 0x00000001u) {
            mutable_selected_rows()->::paddle_mobile::framework::proto::
                VarType_TensorDesc::MergeFrom(from.selected_rows());
        }
        if (cached_has_bits & 0x00000002u) {
            mutable_lod_tensor()->::paddle_mobile::framework::proto::
                VarType_LoDTensorDesc::MergeFrom(from.lod_tensor());
        }
        if (cached_has_bits & 0x00000004u) {
...
VarType::lod_tensor() const {
    ...
    return p != NULL ? *p
                     : *reinterpret_cast<const ::paddle_mobile::framework::
            ...
            if (static_cast<::google::protobuf::uint8>(tag) ==
                ...
                DO_((
                    ::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                        ::google::protobuf::int32,
                        ::google::protobuf::internal::WireFormatLite::
                            TYPE_INT32>(input, &forward_block_idx_)));
            } else {
                goto handle_unusual;
            }
            break;
...
size_t BlockDesc::ByteSizeLong() const {
    ...
    // repeated .paddle_mobile.framework.proto.VarDesc vars = 3;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->vars(static_cast<int>(i)));
        }
    }
    ...
    // repeated .paddle_mobile.framework.proto.OpDesc ops = 4;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->ops(static_cast<int>(i)));
        }
    }
...
size_t ProgramDesc::ByteSizeLong() const {
    ...
    // repeated .paddle_mobile.framework.proto.BlockDesc blocks = 1;
    {
        ...
        for (unsigned int i = 0; i < count; i++) {
            total_size += ::google::protobuf::internal::WireFormatLite::
                MessageSizeNoVirtual(this->blocks(static_cast<int>(i)));
        }
    }

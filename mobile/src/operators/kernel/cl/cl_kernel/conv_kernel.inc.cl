...
/*  half4 inputs[filter_height*filter_width];
   for (int iy = 0; iy < filter_height; ++iy) {
    for (int ix = 0; ix < filter_width; ++ix) {
      // inputs[iy*filter_width+ix] = read_imageh(input_image, sampler,(int2)(input_x_base + fx - align.x,input_y_base + fy - align.y));

      inputs[iy*filter_width+ix] = select(read_imageh(input, sampler, (int2)(input_x_base + fx - align.x, input_y_base + fy - align.y)),
                                          (half4)(0.0f),
                                          (ushort4)((in_pos_in_one_block.x + fy - align.y < 0 || in_pos_in_one_block.y + fy - align.y < 0 || in_pos_in_one_block.x + fx - align.x >= input_width || in_pos_in_one_block.y + fx - align.x >= input_height) << 15));
    }
    ...
    for (int fy = 0; fy < filter_height; ++fy) {
      for (int fx = 0; fx < filter_width; ++fx) {
        filters[fy*filter_width+fx] = read_imageh(filter, sampler,(int2)(filter_x+fx,filter_y+fy));
      }
    }
...
/*      if (output_pos.x == 0 && output_pos.y == 0){
      ...
      half4 in =  select(read_imageh(input, sampler, (int2)(input_x_base + x_off, input_y_base + y_off)),
                      (half4)(0.0f),
                      (ushort4)((in_pos_in_one_block.x + x_off < 0 || in_pos_in_one_block.y + y_off < 0 || in_pos_in_one_block.x + x_off >= input_width || in_pos_in_one_block.y + y_off >= input_height) << 15)) ;
      half4 f = read_imageh(filter, sampler,(int2)(filter_x + fx, filter_y + fy));
...
//
//  inputs[0] = select(read_imageh(input, sampler, (int2)(input_x_base - 1, input_y_base - 1)),
//                     (half4)(0.0f),
//                     (ushort4)((in_pos_in_one_block.x - 1 < 0 || in_pos_in_one_block.y - 1 < 0 || in_pos_in_one_block.x - 1 >= input_width || in_pos_in_one_block.y - 1 >= input_height) << 15));
//
//  inputs[1] = select(read_imageh(input, sampler, (int2)(input_x_base, input_y_base - 1)),
//                     (half4)(0.0f),
//                     (ushort4)((in_pos_in_one_block.x < 0 || in_pos_in_one_block.y - 1 < 0 || in_pos_in_one_block.x >= input_width || in_pos_in_one_block.y - 1 >= input_height) << 15));
//
//  inputs[2] = select(read_imageh(input, sampler, (int2)(input_x_base + 1, input_y_base - 1)),
//                     (half4)(0.0f),
//                     (ushort4)((in_pos_in_one_block.x + 1 < 0 || in_pos_in_one_block.y - 1 < 0 || in_pos_in_one_block.x + 1 >= input_width || in_pos_in_one_block.y - 1 >= input_height) << 15));
//
//  inputs[3] = select(read_imageh(input, sampler, (int2)(input_x_base - 1, input_y_base)),
//                     (half4)(0.0f),
//                     (ushort4)((in_pos_in_one_block.x - 1 < 0 || in_pos_in_one_block.y < 0 || in_pos_in_one_block.x - 1 >= input_width || in_pos_in_one_block.y >= input_height) << 15));
//  /*
//  if (output_pos.x == 112 && output_pos.y == 0) {
...
/*
  ...
  inputs[4] = select(read_imageh(input, sampler, (int2)(input_x_base, input_y_base)),
                     (half4)(0.0f),
                     (ushort4)((in_pos_in_one_block.x < 0 || in_pos_in_one_block.y < 0 || in_pos_in_one_block.x >= input_width || in_pos_in_one_block.y >= input_height) << 15));

  inputs[5] = select(read_imageh(input, sampler, (int2)(input_x_base + 1, input_y_base)),
                     (half4)(0.0f),
                     (ushort4)((in_pos_in_one_block.x + 1 < 0 || in_pos_in_one_block.y < 0 || in_pos_in_one_block.x + 1 >= input_width || in_pos_in_one_block.y >= input_height) << 15));

  inputs[6] = select(read_imageh(input, sampler, (int2)(input_x_base - 1, input_y_base + 1)),
                     (half4)(0.0f),
                     (ushort4)((in_pos_in_one_block.x - 1 < 0 || in_pos_in_one_block.y + 1 < 0 || in_pos_in_one_block.x - 1 >= input_width || in_pos_in_one_block.y + 1 >= input_height) << 15));

  inputs[7] = select(read_imageh(input, sampler, (int2)(input_x_base, input_y_base + 1)),
                     (half4)(0.0f),
                     (ushort4)((in_pos_in_one_block.x < 0 || in_pos_in_one_block.y + 1 < 0 || in_pos_in_one_block.x >= input_width || in_pos_in_one_block.y + 1 >= input_height) << 15));

  inputs[8] = select(read_imageh(input, sampler, (int2)(input_x_base + 1, input_y_base + 1)),
                     (half4)(0.0f),
                     (ushort4)((in_pos_in_one_block.x + 1 < 0 || in_pos_in_one_block.y + 1 < 0 || in_pos_in_one_block.x + 1 >= input_width || in_pos_in_one_block.y + 1 >= input_height) << 15));
*/
...
__kernel void depth_conv(__private const int global_size_dim0,
                             __private const int global_size_dim1,
                             __private const int global_size_dim2,
                             __read_only image2d_t input,
                             __read_only image2d_t filter,

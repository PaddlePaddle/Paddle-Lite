...
int ConvertElementwise(Converter* converter, core::Operation* operation) {
  ...
  std::map<NNAdapterOperationType, const char*> op_type_map{
      ...
      {NNADAPTER_SUB, QNN_OP_ELEMENT_WISE_SUBTRACT},
      {NNADAPTER_MUL, QNN_OP_ELEMENT_WISE_MULTIPLY},
      {NNADAPTER_DIV, QNN_OP_ELEMENT_WISE_DIVIDE},
      {NNADAPTER_MAX, QNN_OP_ELEMENT_WISE_MAXIMUM},
      {NNADAPTER_MIN, QNN_OP_ELEMENT_WISE_MINIMUM},
      {NNADAPTER_POW, QNN_OP_ELEMENT_WISE_POWER},
  };

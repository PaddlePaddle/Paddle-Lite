...
|armv8   |OFF |ON |[v2.10](https://github.com/PaddlePaddle/Paddle-Lite/releases/download/v2.10/inference_lite_lib.armlinux.armv8.gcc.with_cv.tar.gz)               |RK3399                 |firefly (Linux) |
|armv8   |ON |OFF |[v2.10](https://github.com/PaddlePaddle/Paddle-Lite/releases/download/v2.10/inference_lite_lib.armlinux.armv8.gcc.with_extra.tar.gz)            |RK3399                 |firefly (Linux) |
|armv8   |ON |ON |[v2.10](https://github.com/PaddlePaddle/Paddle-Lite/releases/download/v2.10/inference_lite_lib.armlinux.armv8.gcc.with_extra.with_cv.tar.gz)    |RK3399                 |firefly (Linux) |
...
|:-----:|:-----:|:-----:|
|OFF |[v2.10](https://github.com/PaddlePaddle/Paddle-Lite/releases/download/v2.10/inference_lite_lib.x86.linux.tar.gz)             |Ubuntu (Linux) |
|ON  |[v2.10](https://github.com/PaddlePaddle/Paddle-Lite/releases/download/v2.10/inference_lite_lib.x86.linux.with_log.tar.gz)    |Ubuntu (Linux) |
...
|x86 |3.9 |[v2.10](https://github.com/PaddlePaddle/Paddle-Lite/releases/download/v2.10/inference_lite_lib.win.x86.MSVC.C++_static.py39.full_publish.zip) |
...
|Arch |下载链接 |适用的操作系统 |
|:-----:|:-----:|:-----:|
|x86   |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.centos.x86.baidu_xpu.tar.gz) |CentOS 6.3 |
|x86   |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.ubuntu.x86.baidu_xpu.tar.gz) |Ubuntu     |
|armv8 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.ky10.armv8.baidu_xpu.tar.gz) |银河麒麟v10 |
...
|Arch |下载链接 |适用的操作系统 |
|:-----:|:-----:|:-----:|
|x86   |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.ubuntu.x86.huawei_ascend_npu.tar.gz) |Ubuntu    |
|armv8 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.ky10.armv8.huawei_ascend_npu.tar.gz) |银河麒麟v10 |
...
|Arch |下载链接 |
|:-----:|:-----:|
|armv7 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.android.armv7.huawei_kirin_npu.with_cv.with_extra.with_log.tiny_publish.tar.gz) |
|armv8 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.android.armv8.huawei_kirin_npu.with_cv.with_extra.with_log.tiny_publish.tar.gz) |
...
|Arch |下载链接 |
|:-----:|:-----:|
|armv7hf |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.armlinux.armv7hf.rockchip_npu.with_extra.with_log.tiny_publish.tar.gz) |
|armv8   |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.armlinux.armv8.rockchip_npu.with_extra.with_log.tiny_publish.tar.gz)   |
...
|Arch |下载链接 |适用的操作系统 |
|:-----:|:-----:|:-----:|
|armv7 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.android.armv7.amlogic_npu.with_extra.with_log.tiny_publish.tar.gz)  |Android |
|armv8 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.armlinux.armv8.amlogic_npu.with_extra.with_log.tiny_publish.tar.gz) |Linux   |
...
|Arch |下载链接 |
|:-----:|:-----:|
|armv7 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.android.armv7.mediatek_apu.with_extra.with_log.tiny_publish.tar.gz) |
|armv8 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.android.armv8.mediatek_apu.with_extra.with_log.tiny_publish.tar.gz) |
...
|Arch |下载链接 |
|:-----:|:-----:|
|armv8 |[v2.10](https://paddlelite-data.bj.bcebos.com/release/v2.10/inference_lite_lib.armlinux.armv8.imagination_nna.with_extra.with_log.tiny_publish.tar.gz) |

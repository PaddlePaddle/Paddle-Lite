...
| OP_name| ARM | OpenCL | Metal | 昆仑芯XPU | Host | X86 | 比特大陆 | 英特尔FPGA | 寒武纪mlu | 华为昇腾NPU | 联发科APU | 瑞芯微NPU | 华为麒麟NPU | 颖脉NNA | 晶晨NPU | 芯原TIM-VX | Android NN API|
|-:|-| -| -| -| -| -| -| -| -| -| -| -| -| -| -| -| -|
|                   affine_channel|Y| | | | | | | | | | | | | | | | |
|                      affine_grid|Y| | | | | | | | | | | | | | | | |
|                          arg_max|Y|Y| |Y|Y| | | |Y|Y| | | | | | | |
...
|                  elementwise_add|Y|Y|Y|Y| |Y|Y| |Y|Y|Y|Y|Y| |Y|Y|Y|
...
|                          reshape| |Y| |Y|Y| |Y| |Y|Y|Y|Y|Y| |Y|Y|Y|

...
| OP_name| ARM | OpenCL | Metal | 昆仑芯XPU | Host | X86 | 寒武纪mlu | 华为昇腾NPU | 联发科APU | 华为麒麟NPU | 颖脉NNA | 芯原TIM-VX | Android NNAPI| Intel OpenVINO |
|-:|-| -| -| -| -| -| -| -| -| -| -| -| -| -|
|                   affine_channel|Y| | | | | | | | | | | | | |
|                      affine_grid|Y| | | | | | | | | | | | | |
|                          arg_max|Y|Y|Y|Y|Y| |Y|Y| |Y| | | | |
|                     assign_value| | | |Y|Y| | | | | | | | | |
|                       batch_norm|Y|Y|Y|Y| |Y|Y|Y| |Y| |Y| |Y|
...
|                  elementwise_div|Y|Y|Y|Y| |Y| |Y|Y|Y|Y|Y|Y| |
...
|                          flatten| |Y|Y|Y|Y| |Y|Y|Y|Y| |Y|Y| |
|                         flatten2| |Y|Y|Y|Y| |Y|Y|Y|Y| |Y|Y| |
|         flatten_contiguous_range| | | |Y|Y| | |Y|Y|Y| |Y| | |

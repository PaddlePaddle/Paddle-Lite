...
当前Paddle-Lite共计支持算子269个，其中基础算子91个，附加算子178个。
...
| OP_name | Host | X86 | CUDA | ARM | OpenCL | FPGA | 华为NPU | 百度XPU | 瑞芯微NPU | 联发科APU | 华为升腾NPU | 颖脉NNA | 英特尔FPGA | 比特大陆 
|-:|-| -| -| -| -| -| -| -| -| -| -| -| -| -| 
| affine_channel |   |   |   | Y |   |   |   |   |   |   |   |   |   |   |
| affine_grid |   |   |   | Y |   |   |   |   |   |   |   |   |   |   |
| arg_max | Y |   |   | Y |   |   | Y | Y |   |   | Y |   |   |   |
...
| bilinear_interp_v2 |   | Y |   | Y | Y |   |   | Y |   | Y |   |   |   |   |
| box_coder | Y | Y |   | Y | Y |   |   | Y |   |   |   |   |   | Y |
| calib |   |   | Y | Y |   | Y |   | Y |   |   |   |   |   |   |
| cast |   | Y |   | Y |   | Y |   | Y |   | Y | Y |   |   | Y |
| concat |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| conv2d |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |
| conv2d_transpose |   | Y |   | Y | Y | Y | Y | Y |   | Y |   |   |   | Y |
| density_prior_box |   | Y |   |   |   |   |   | Y |   |   |   |   |   | Y |
| depthwise_conv2d |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |
| depthwise_conv2d_transpose |   |   |   |   |   |   |   |   |   |   |   |   |   | Y |
| dropout |   | Y | Y | Y | Y | Y | Y | Y |   | Y | Y |   |   | Y |
| elementwise_add |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| elementwise_div |   | Y |   | Y |   |   | Y | Y | Y | Y | Y |   |   | Y |
| elementwise_floordiv |   | Y |   | Y |   |   |   |   |   |   |   |   |   |   |
| elementwise_max |   | Y |   | Y |   |   |   | Y |   | Y | Y |   |   |   |
| elementwise_min |   | Y |   | Y |   |   |   |   |   | Y | Y |   |   |   |
| elementwise_mod |   | Y |   | Y |   |   |   |   |   |   |   |   |   |   |
| elementwise_mul |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| elementwise_pow |   | Y |   | Y |   |   |   |   |   |   |   |   |   |   |
| elementwise_sub |   | Y | Y | Y | Y |   | Y | Y | Y | Y | Y |   |   | Y |
| elu |   |   |   | Y |   |   |   |   |   |   |   |   |   |   |
| erf |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| expand | Y |   |   |   | Y |   | Y |   |   |   |   |   |   |   |
| expand_as | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| fc |   | Y | Y | Y | Y | Y | Y |   | Y | Y | Y | Y |   |   |
| feed | Y |   | Y |   |   | Y |   |   |   |   |   |   |   |   |
| fetch | Y |   |   |   |   | Y |   |   |   |   |   |   |   |   |
| fill_constant | Y |   |   |   |   |   | Y | Y |   | Y |   |   |   | Y |
| fill_constant_batch_size_like | Y |   |   |   |   |   | Y | Y |   |   |   |   |   |   |
| flatten | Y |   |   |   | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| flatten2 | Y |   |   |   | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| flatten_contiguous_range |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
| fusion_elementwise_add_activation |   |   | Y | Y | Y | Y | Y |   | Y | Y | Y |   |   |   |
| fusion_elementwise_div_activation |   |   |   | Y |   |   | Y |   | Y | Y | Y |   |   |   |
| fusion_elementwise_max_activation |   |   |   | Y |   |   |   |   |   | Y | Y |   |   |   |
| fusion_elementwise_min_activation |   |   |   | Y |   |   |   |   |   | Y | Y |   |   |   |
| fusion_elementwise_mul_activation |   |   | Y | Y |   |   | Y |   | Y | Y | Y |   |   |   |
| fusion_elementwise_sub_activation |   |   | Y | Y | Y |   | Y |   | Y | Y | Y |   |   |   |
| grid_sampler |   |   |   | Y | Y |   |   | Y |   |   |   |   |   |   |
| instance_norm |   | Y |   | Y | Y |   | Y | Y |   |   |   |   |   |   |
| io_copy |   |   | Y |   | Y | Y |   | Y |   |   |   |   |   |   |
| io_copy_once |   |   | Y |   | Y | Y |   | Y |   |   |   |   |   |   |
| layout |   |   | Y | Y | Y | Y |   |   |   |   |   |   |   |   |
| layout_once |   |   | Y | Y | Y | Y |   |   |   |   |   |   |   |   |
...
| nearest_interp_v2 |   | Y |   | Y | Y |   |   | Y |   | Y |   |   |   |   |
| pad2d |   |   |   | Y | Y |   | Y |   | Y |   |   |   |   |   |
| pool2d |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   | Y |
| prelu |   |   |   | Y | Y |   |   | Y |   |   |   |   |   |   |
| prior_box | Y |   |   |   |   | Y |   | Y |   |   | Y |   |   | Y |
| range | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| reduce_mean |   | Y |   | Y | Y | Y | Y | Y |   | Y | Y |   |   | Y |
| relu |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   | Y |
| relu6 |   | Y |   | Y | Y |   | Y | Y | Y | Y | Y |   |   |   |
| reshape | Y |   |   |   | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| reshape2 | Y |   |   |   | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| scale |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| search_fc |   |   |   |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_topk_avg_pooling |   | Y |   |   |   |   |   | Y |   |   |   |   |   |   |
| shuffle_channel |   |   |   | Y | Y |   | Y |   |   |   |   |   |   |   |
| sigmoid |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| slice |   | Y |   | Y | Y | Y |   | Y |   | Y | Y |   |   | Y |
| softmax |   | Y | Y | Y | Y |   | Y | Y | Y | Y | Y | Y |   | Y |
| softplus |   |   |   |   |   |   | Y |   |   |   | Y |   |   |   |
| split | Y |   |   |   | Y | Y | Y | Y | Y | Y |   |   |   | Y |
| squeeze | Y |   |   |   | Y |   |   |   |   | Y |   |   |   | Y |
| squeeze2 | Y |   |   |   | Y |   |   |   |   | Y |   |   |   | Y |
| stack | Y | Y |   |   |   |   |   | Y |   |   |   |   |   |   |
| subgraph |   |   |   |   |   | Y | Y |   | Y | Y | Y | Y |   |   |
| sync_batch_norm |   | Y |   | Y | Y |   |   |   |   |   |   |   |   |   |
| tanh |   | Y | Y | Y | Y |   | Y | Y | Y | Y | Y |   |   |   |
| thresholded_relu |   |   |   | Y |   |   | Y |   |   |   |   |   |   |   |
| transpose |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| transpose2 |   | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
...
| logical_or | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| logical_xor | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| lookup_table |   | Y | Y | Y |   |   | Y | Y |   |   |   |   |   |   |
| lookup_table_dequant |   |   |   | Y |   |   |   |   |   |   |   |   |   |   |
| lookup_table_v2 |   | Y | Y | Y |   |   |   | Y |   |   |   |   |   |   |
| lrn |   |   |   | Y | Y |   |   | Y |   |   |   |   |   |   |
| lstm |   |   |   | Y |   |   |   |   |   |   |   |   |   |   |
| match_matrix_tensor |   | Y | Y |   |   |   |   | Y |   |   |   |   |   |   |
| matmul |   | Y | Y | Y | Y |   | Y | Y |   |   | Y |   |   | Y |
| matmul_v2 |   |   |   | Y | Y |   |   | Y |   |   |   |   |   |   |
| matrix_nms | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
...
| reduce_prod |   | Y |   | Y |   |   |   | Y |   |   |   |   |   |   |
| reduce_sum |   | Y |   | Y |   |   |   | Y |   |   |   |   |   | Y |
| relu | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   | Y |
| relu6 | Y | Y |   | Y | Y |   | Y | Y | Y | Y | Y |   |   |   |
| relu_clipped | Y |   |   | Y |   |   | Y |   |   |   |   |   |   |   |
| reshape | Y |   |   |   | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| reshape2 | Y |   |   |   | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
...
| search_seq_arithmetic |   | Y | Y |   |   |   |   | Y |   |   |   |   |   |   |
| search_seq_depadding |   | Y | Y |   |   |   |   |   |   |   |   |   |   |   |
| search_seq_fc |   | Y | Y |   |   |   |   |   |   |   |   |   |   |   |
| search_seq_softmax |   | Y | Y |   |   |   |   |   |   |   |   |   |   |   |
| select_input | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| sequence_arithmetic |   | Y | Y |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_concat |   | Y | Y |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_conv |   | Y |   | Y |   |   |   |   |   |   |   |   |   |   |
| sequence_expand | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| sequence_expand_as |   | Y |   | Y |   |   |   |   |   |   |   |   |   |   |
| sequence_mask | Y |   | Y |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_pad | Y |   | Y |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_pool |   | Y | Y | Y |   |   |   | Y |   |   |   |   |   |   |
| sequence_pool_concat |   |   | Y |   |   |   |   |   |   |   |   |   |   |   |
| sequence_reshape |   | Y |   |   |   |   |   |   |   |   |   |   |   |   |
| sequence_reverse |   | Y | Y |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_reverse_embedding |   |   | Y |   |   |   |   |   |   |   |   |   |   |   |
| sequence_softmax | Y |   |   |   |   |   |   |   |   |   |   |   |   |   |
| sequence_topk_avg_pooling |   | Y | Y |   |   |   |   | Y |   |   |   |   |   |   |
| sequence_unpad | Y |   | Y |   |   |   |   | Y |   |   |   |   |   |   |
| shape | Y |   |   |   | Y | Y | Y |   |   | Y | Y |   |   | Y |
| shuffle_channel | Y |   |   | Y | Y |   | Y |   |   |   |   |   |   |   |
| sigmoid | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |   |   | Y |
| sign |   |   |   | Y |   |   |   | Y |   |   |   |   |   |   |
| sin | Y |   |   |   | Y |   |   |   |   |   |   |   |   |   |
| slice |   | Y |   | Y | Y | Y |   | Y |   | Y | Y |   |   | Y |
| softmax |   | Y | Y | Y | Y |   | Y | Y | Y | Y | Y | Y |   | Y |
...
| yolo_box | Y |   | Y |   | Y | Y |   | Y |   |   |   |   |   | Y |
| __xpu__bigru |   |   |   |   |   |   |   | Y |   |   |   |   |   |   |
| __xpu__block_fuse_op |   |   |   |   |   |   |   | Y |   |   |   |   |   |   |
| __xpu__conv2d |   |   |   |   |   |   |   | Y |   |   |   |   |   |   |
| __xpu__conv_pixel_shuffle_fuse_op |   |   |   |   |   |   |   | Y |   |   |   |   |   |   |

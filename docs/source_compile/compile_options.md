...
| LITE_BUILD_TAILOR | 编译时[根据模型裁剪预测库](library_tailoring.md)，缩小预测库大小 | OFF |
...
| LITE_WITH_NPU |  编译 [华为 NPU 平台](../demo_guides/huawei_kirin_npu.md)预测库 | NPU | OFF |
| LITE_WITH_RKNPU |  编译[瑞芯微 NPU 平台](../demo_guides/rockchip_npu.md)预测库 | RKNPU | OFF |
...
| LITE_WITH_APU | 编译[联发科 APU 平台](../demo_guides/mediatek_apu.md)预测库 | APU |OFF |

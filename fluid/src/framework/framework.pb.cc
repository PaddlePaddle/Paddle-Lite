...
void TableStruct::InitDefaultsImpl() {
  ...
  _VarType_LoDTensorDesc_default_instance_._instance.get_mutable()->tensor_ =
      const_cast<::paddle::framework::proto::VarType_TensorDesc*>(
          ::paddle::framework::proto::VarType_TensorDesc::
  ...
  _VarDesc_default_instance_._instance.get_mutable()->type_ =
      const_cast<::paddle::framework::proto::VarType*>(
...
const ::paddle::framework::proto::OpProto_Var& OpProto::inputs(
    int index) const {
...
const ::paddle::framework::proto::OpProto_Var& OpProto::outputs(
    int index) const {
...
const ::paddle::framework::proto::OpProto_Attr& OpProto::attrs(
    int index) const {
      ...
      case 1: {
        if (static_cast<::google::protobuf::uint8>(tag) ==
          ...
          if (::paddle::framework::proto::VarType_Type_IsValid(value)) {
            set_data_type(
                static_cast<::paddle::framework::proto::VarType_Type>(value));
          } else {
...
void VarType_LoDTensorDesc::MergeFrom(const VarType_LoDTensorDesc& from) {
  ...
  if (cached_has_bits & 3u) {
    if (cached_has_bits & 0x00000001u) {
      mutable_tensor()
          ->::paddle::framework::proto::VarType_TensorDesc::MergeFrom(
              from.tensor());
    }
    if (cached_has_bits & 0x00000002u) {
      lod_level_ = from.lod_level_;
...
::paddle::framework::proto::VarType_Type VarType_ChannelDesc::data_type()
    const {
...
::paddle::framework::proto::VarType_Type VarType_Tuple::element_type(
    int index) const {
...
VarType::VarType(const VarType& from)
  ...
  if (from.has_channel()) {
    channel_ =
        new ::paddle::framework::proto::VarType_ChannelDesc(*from.channel_);
  } else {
    channel_ = NULL;
  }
  if (from.has_tuple()) {
...
#define DO_(EXPRESSION) \
  ...
  for (;;) {
    ...
    switch (
      ...
      // optional .paddle.framework.proto.VarType.LoDTensorArrayDesc
      // tensor_array = 4;
      case 4: {
        if (static_cast<::google::protobuf::uint8>(tag) ==
            static_cast<::google::protobuf::uint8>(34u /* 34 & 0xFF */)) {
...
void VarType::MergeFrom(const VarType& from) {
  ...
  if (cached_has_bits & 127u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      mutable_lod_tensor()
          ->::paddle::framework::proto::VarType_LoDTensorDesc::MergeFrom(
              from.lod_tensor());
    }
    if (cached_has_bits & 0x00000004u) {
      mutable_tensor_array()
          ->::paddle::framework::proto::VarType_LoDTensorArrayDesc::MergeFrom(
              from.tensor_array());
    }
    if (cached_has_bits & 0x00000008u) {
      mutable_reader()
          ->::paddle::framework::proto::VarType_ReaderDesc::MergeFrom(
              from.reader());
    }
    if (cached_has_bits & 0x00000010u) {
      mutable_channel()
          ->::paddle::framework::proto::VarType_ChannelDesc::MergeFrom(
              from.channel());
    }
    if (cached_has_bits & 0x00000020u) {
      mutable_tuple()->::paddle::framework::proto::VarType_Tuple::MergeFrom(
          from.tuple());
    }
    if (cached_has_bits & 0x00000040u) {
      type_ = from.type_;
...
const ::paddle::framework::proto::VarType_TensorDesc& VarType::selected_rows()
    const {
...
const ::paddle::framework::proto::VarType_LoDTensorDesc& VarType::lod_tensor()
    const {
...
const ::paddle::framework::proto::VarType_ChannelDesc& VarType::channel()
    const {
...
void VarDesc::MergeFrom(const VarDesc& from) {
  ...
  if (cached_has_bits & 7u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      mutable_type()->::paddle::framework::proto::VarType::MergeFrom(
          from.type());
    }
    if (cached_has_bits & 0x00000004u) {
      persistable_ = from.persistable_;
...
const ::paddle::framework::proto::BlockDesc& ProgramDesc::blocks(
    int index) const {

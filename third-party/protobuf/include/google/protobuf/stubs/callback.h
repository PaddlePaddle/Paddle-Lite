...
template <typename R> class ResultCallback {
  public:
    ResultCallback() {}
...
template <typename R, typename A1> class LIBPROTOBUF_EXPORT ResultCallback1 {
  public:
    ResultCallback1() {}
...
template <typename T> struct InternalConstRef {
...
// See ResultCallback
template <typename R> inline ResultCallback<R> *NewCallback(R (*function)()) {
...
inline ResultCallback<R> *NewPermanentCallback(T1 *object,
                                               R (T2::*function)()) {
    return new internal::MethodResultCallback_0_0<R, T1>(object, function,
                                                         false);
}
...
template <typename R, typename T, typename P1, typename P2, typename P3,
          typename P4, typename P5, typename A1, typename A2>
inline ResultCallback2<R, A1, A2> *
NewPermanentCallback(T *object, R (T::*function)(P1, P2, P3, P4, P5, A1, A2),

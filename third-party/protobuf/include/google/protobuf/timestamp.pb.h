...
LIBPROTOBUF_EXPORT extern TimestampDefaultTypeInternal
...
class LIBPROTOBUF_EXPORT Timestamp
    : public ::google::protobuf::
          Message /* @@protoc_insertion_point(class_definition:google.protobuf.Timestamp)
                   */
{
  public:
    Timestamp();
...
// int64 seconds = 1;
inline void Timestamp::clear_seconds() { seconds_ = GOOGLE_LONGLONG(0); }
...
// int32 nanos = 2;
inline void Timestamp::clear_nanos() { nanos_ = 0; }

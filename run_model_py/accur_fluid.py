...
def diff_fluid(device_id, model_lists, input_shapes, threads, arm_abi):
	...
	for name in ['paddle_pose_merged_models', 'paddle_gesture_merged_models']:
		...
		'''
		if name == 'merge21_ssd_shufflenet_quant-fluild' or name == 'int8':
			i = i + 1
			continue
...
input_shapes = ['1,3,192,192', '1,3,256,256', '1,3,64,64', '1,3,24,24', '1,3,224,224', '1,3,192,192',
...
# model_lists = ['merge21-sbl-shufflenet-fluid', 'merge21_ssd_shufflenet_quant-fluild']
# input_shapes = ['1,3,192,192', '1,3,256,256']
# model_lists = ['paddle_pose_merged_models', 'paddle_gesture_merged_models']
# input_shapes = ['1,3,128,128', '1,3,192,144', '1,3,192,144', '1,3,96,96', '1,3,128,128', '1,3,112,112']

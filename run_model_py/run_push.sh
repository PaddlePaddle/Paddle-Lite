...
# adb -s ${1} push $MODLE_PATH/merge21_ssd_shufflenet_quant-fluild $BIN_PATH/model
# adb -s ${1} push $MODLE_PATH/merge21-sbl-shufflenet-fluid $BIN_PATH/model
# adb -s ${1} push $MODLE_PATH/paddle_gesture_merged_models $BIN_PATH/model
# adb -s ${1} push $MODLE_PATH/paddle_pose_merged_models $BIN_PATH/model

# adb -s ${1} shell "cd $BIN_PATH && rm *.txt && exit"
echo "adb push model_test"
UNIT_V7_TEST_ROOT="/home/chenjiao04/dev_my/Paddle-Lite/build.lite.android.armv7.gcc"
UNIT_V8_TEST_ROOT="/home/chenjiao04/dev_my/Paddle-Lite/build.lite.android.armv8.gcc"

...
def write_data(files, path):
    ...
    for file_path in files:
        ...
        title = [[name, 'model', '1', '2', '4', ' ', '1', '2', '4', ' ', '1', '2', '4'],]
        # title = [[name, 'model', '1', '2', '4', ' ', '1', '2', '4', ' ', '1', '2', '4', ' ', '1', '2', '4'],]
        if first:
...
def read_txt(file_path):
    ...
    while line:
        ...
        temp['max'] = data[4].split(':')[1].strip().split(' ')[0]
        # temp['mid'] = data[4].split(':')[1].strip().split(' ')[0]
        # temp['var'] = data[5].split(':')[1].strip()
        val[thread] = temp
        val_dict[model] = val
        line = fp.readline()
    ...
    for key in val_dict.keys():
        ...
        temp.append('  ')
        temp.append(val['1']['min'])
        temp.append(val['2']['min'])
        temp.append(val['4']['min'])
        temp.append('  ')
        temp.append(val['1']['max'])
        temp.append(val['2']['max'])
        temp.append(val['4']['max'])
        # temp.append(val['1']['mid'])
        # temp.append(val['2']['mid'])
        # temp.append(val['4']['mid'])
        # temp.append('  ')
...
if __name__ == '__main__':
    # files = ['time_17c3cc34_v7.txt'], 'time_5380268d_v7.txt', 'time_5380268d_v8.txt'
    files = ['time_17c3cc34_v7.txt', 'time_17c3cc34_v8.txt', 'time_7f1446bd_v7.txt', 'time_7f1446bd_v8.txt']
    path = sys.argv[1]

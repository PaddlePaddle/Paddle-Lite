...
class TestCorrelationOp(AutoScanTest):
    ...
    def sample_program_configs(self, draw):
        ...
        pad_size = draw(st.integers(min_value = 0, max_value = 256))
        kernel_size = draw(st.integers(min_value = 1, max_value = 30))
        max_displacement = draw(st.integers(min_value = 1, max_value = 30))
        stride1 = draw(st.integers(min_value = 1, max_value = 30))
        stride2 = draw(st.integers(min_value = 1, max_value = 30))
        corr_type_multiply = draw(st.integers(min_value = 1, max_value = 30))
    ...
    def sample_predictor_configs(self):
        config = CxxConfig()
        return self.get_predictor_configs(), ["correlation"], (1e-5, 1e-5)

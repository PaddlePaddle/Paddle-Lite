...
class TestExpandOp(AutoScanTest):
    def __init__(self, *args, **kwargs):
         ...
         host_places = [Place(TargetType.Host, PrecisionType.INT32, DataLayoutType.NCHW),
                        Place(TargetType.Host, PrecisionType.INT64, DataLayoutType.NCHW),
                        Place(TargetType.Host, PrecisionType.FP32, DataLayoutType.NCHW)]
         arm_places = [Place(TargetType.ARM, PrecisionType.INT32, DataLayoutType.NCHW),
    ...
    def sample_program_configs(self, draw):
        ...
        expand_shape = draw(st.lists(st.integers(min_value=1, max_value=4), min_size=len(in_shape), max_size=len(in_shape)))
        ...
        attr_shape = draw(st.lists(st.integers(min_value=1, max_value=8), min_size=len(in_shape), max_size=len(in_shape)))

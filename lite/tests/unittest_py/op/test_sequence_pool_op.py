...
class TestSequenceReshapeOp(AutoScanTest):
    ...
    def sample_program_configs(self, draw):
        in_shape = draw(st.lists(st.integers(min_value=13, max_value=64), min_size=2, max_size=3))
        ...
        program_config = ProgramConfig(
            ...
            inputs={
                "input_data": TensorConfig(data_gen=partial(generate_input), lod=lod_tensor)
            },

...
def sample_program_configs(draw):
    # in_shape= [N,C,H,W]
    # H = W
    in_shape = draw(st.lists(st.integers(min_value=5, max_value=100), min_size = 4, max_size=4))
    ...
    anchors_data = draw(st.lists(st.integers(min_value=10, max_value=13), min_size = 4, max_size=4))
    ...
    program_config = ProgramConfig(
        ...
        inputs={
            ...
            "ImgSize_data": TensorConfig(data_gen=partial(generate_ImgSize_data)),
        },

...
import test_scaleacts_fuse_pass_base
...
class TestScaleactsFusePass(FusePassAutoScanTest):
    ...
    def sample_program_configs(self, *args, **kwargs):
        return test_scaleacts_fuse_pass_base.sample_program_configs(*args, **kwargs)
    ...
    def test(self, *args, **kwargs):
        self.run_and_statis(quant=False, max_examples=50, passes=["lite_scaleacts_fuse_pass"])

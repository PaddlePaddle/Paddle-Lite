...
import test_flatten_fc_fuse_pass_base
...
class TestScaleActiveFusePass(FusePassAutoScanTest):
    ...
    def sample_program_configs(self, draw):
        return test_flatten_fc_fuse_pass_base.sample_program_configs(draw)
    ...
    def test(self, *args, **kwargs):
        self.run_and_statis(quant=False, max_examples=25, passes=["lite_flatten_fc_fuse_pass"])

...
import test_transpose_softmax_transpose_pass_base 
...
class TestTransposeSoftmaxTransposeFusePass(FusePassAutoScanTest):
    ...
    def sample_program_configs(self, draw):
        return test_transpose_softmax_transpose_pass_base.sample_program_configs(draw)
    ...
    def test(self, *args, **kwargs):
        self.run_and_statis(quant=False, max_examples=25, passes=["lite_transpose_softmax_transpose_fuse_pass"])

...
def sample_program_configs(draw):
    transpose1_input_shape = draw(st.lists(st.integers(min_value=1, max_value=10), min_size=4, max_size=4))
    axis_dim4 = draw(st.lists(st.integers(min_value=0, max_value=3), min_size=4, max_size=4))
    assume(sorted(axis_dim4)==[0, 1, 2, 3])
    axis_dim4_1 = [axis_dim4.index(0),axis_dim4.index(1), axis_dim4.index(2), axis_dim4.index(3)]    

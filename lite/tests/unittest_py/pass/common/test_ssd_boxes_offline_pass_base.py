...
def sample_program_configs(draw):
    ...
    if prior_box_type == "density_prior_box":
        ...
        density_prior_box_layer1_channels = draw(st.integers(min_value=10, max_value=40))
        density_prior_box_layer1_w = draw(st.integers(min_value=30, max_value=40))
        density_prior_box_layer1_h = draw(st.integers(min_value=30, max_value=40))

        density_prior_box_layer2_channels = draw(st.integers(min_value=10, max_value=40))
        density_prior_box_layer2_w = draw(st.integers(min_value=30, max_value=40))
        ...
        fixed_sizes_1 = draw(st.lists(st.floats(min_value=1, max_value=80), min_size=3, max_size=3))
        densities_1 = draw(st.lists(st.integers(min_value=1, max_value=10), min_size=3, max_size=3))
        fixed_ratios_1 = draw(st.lists(st.floats(min_value=1, max_value=10), min_size=1, max_size=1))

        fixed_sizes_2 = draw(st.lists(st.floats(min_value=1, max_value=80), min_size=2, max_size=2))
        densities_2 = draw(st.lists(st.integers(min_value=1, max_value=10), min_size=2, max_size=2))
        fixed_ratios_2 = draw(st.lists(st.floats(min_value=1, max_value=10), min_size=1, max_size=1))
        ...
        density_prior_box_op_1 = OpConfig(
            ...
            inputs = {"Input": ["density_prior_box_input_data_1"],
                    "Image": ["density_prior_box_input_image"]},
            outputs = {"Boxes": ["density_prior_box_output_boxes_1"],
        ...
        density_prior_box_op_2 = OpConfig(
            type = "density_prior_box",
            inputs = {"Input": ["density_prior_box_input_data_2"],
                    "Image": ["density_prior_box_input_image"]},
        ...
        ops = [density_prior_box_op_1, density_prior_box_op_2, reshape2_op_1, reshape2_op_2, reshape2_op_3, reshape2_op_4, concat_op_1, concat_op_2, box_coder_op]
        program_config = ProgramConfig(
            ops=ops,
            weights={},
            inputs={
                "density_prior_box_input_data_1": TensorConfig(data_gen=partial(generate_density_prior_box1)),
                "density_prior_box_input_data_2": TensorConfig(data_gen=partial(generate_density_prior_box2)),
                "density_prior_box_input_image": TensorConfig(data_gen=partial(generate_image)),
                "targetbox_data": TensorConfig(data_gen=partial(generate_targetbox), lod=lod_data),
            },
        ...
        density_prior_box_layer1_channels = draw(st.integers(min_value=30, max_value=40))
        density_prior_box_layer1_w = draw(st.integers(min_value=30, max_value=80))
        density_prior_box_layer1_h = draw(st.integers(min_value=30, max_value=80))

        density_prior_box_layer2_channels = draw(st.integers(min_value=30, max_value=40))
        density_prior_box_layer2_w = draw(st.integers(min_value=30, max_value=80))
        density_prior_box_layer2_h = draw(st.integers(min_value=30, max_value=80))

...
def sample_program_configs(draw):
    ...
    dim2_values = draw(st.lists(st.integers(min_value = 1, max_value = 40), min_size = 2, max_size = 2))
    dim4_values = draw(st.lists(st.integers(min_value = 1, max_value = 20), min_size = 4, max_size = 4))
    assume((dim2_values[0] * dim2_values[1]) == (dim4_values[0] * dim4_values[1]))

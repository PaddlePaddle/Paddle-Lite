...
def sample_program_configs(draw):
    reshape1_input_shape = draw(st.lists(st.integers(min_value = 1, max_value = 128), min_size = 4, max_size = 4))
    reshape1_output_shape = draw(st.lists(st.integers(min_value = 1, max_value = 128), min_size = 5, max_size = 5))
    reshape2_output_shape = draw(st.lists(st.integers(min_value = 1, max_value = 128), min_size = 4, max_size = 4))
    ...
    assume(reshape1_output_shape[1]*reshape1_output_shape[2] == reshape1_input_shape[1])

...
*/
//yvu  store hwc bgrabgra dsth * dstw = srch * srcw y_w = srcw, y_h = srch uv_w = srcw uv_h = 1/2 * srch
void nv21_to_bgra(const unsigned char* src, unsigned char* dst, int srcw, int srch){

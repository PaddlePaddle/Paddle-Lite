...
DEFINE_int32(height, 320, "image height");
DEFINE_int32(width, 320, "image width");

namespace paddle {
namespace lite {

TEST(ssdlite_mobilenet_v3_small,
     test_ssdlite_mobilenet_v3_small_coco_fp32_static_nnadapter) {

...
TEST(deeplabv3p, test_deeplabv3p_resnet50_os8_cityscapes_fp32_v2_3_nnadapter) {
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir =
      FLAGS_data_dir + std::string("/deeplabv3p_cityscapes_input.txt");
  std::string output_data_dir =
      FLAGS_data_dir + std::string("/deeplabv3p_cityscapes_output.txt");

...
TEST(unet_cityscapes, test_unet_cityscapes_fp32_v2_3_nnadapter) {
...
// TODO(hong19860320) Fix core dump when ExecuteShape is called.
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir =
      FLAGS_data_dir + std::string("/unet_cityscapes_input.txt");
  std::string output_data_dir =
      FLAGS_data_dir + std::string("/unet_cityscapes_output.txt");

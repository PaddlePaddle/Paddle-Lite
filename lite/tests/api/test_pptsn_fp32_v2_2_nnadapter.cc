...
TEST(ppTSN, test_pptsn_fp32_v2_2_nnadapter) {
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir = FLAGS_data_dir + std::string("/ppTSN_input.txt");
  std::string output_data_dir =
      FLAGS_data_dir + std::string("/ppTSN_output.txt");

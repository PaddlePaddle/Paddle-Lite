...
TEST(pphumanseg_lite, test_pphumanseg_lite_fp32_v2_3_nnadapter) {
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir =
      FLAGS_data_dir + std::string("/pphuman_seg_input.txt");
  std::string output_data_dir =
      FLAGS_data_dir + std::string("/pphuman_seg_output.txt");

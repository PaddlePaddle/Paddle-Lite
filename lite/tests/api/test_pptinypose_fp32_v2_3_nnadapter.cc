...
TEST(pptinypose, test_pptinypose_fp32_v2_3_nnadapter) {
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir =
      FLAGS_data_dir + std::string("/PPtinypose_input.txt");
  std::string output_data_dir =
      FLAGS_data_dir + std::string("/PPtinypose_output.txt");

...
TEST(deeplabv3p, test_deeplabv3p_resnet50_os8_humanseg_fp32_v2_3_nnadapter) {
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir =
      FLAGS_data_dir + std::string("/deeplabv3_input.txt");
  std::string output_data_dir =
      FLAGS_data_dir + std::string("/deeplabv3_output.txt");

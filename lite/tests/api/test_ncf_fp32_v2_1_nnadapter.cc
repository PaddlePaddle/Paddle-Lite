...
// TODO(hong19860320) Gather only support int32 datatype
...
//   nnadapter_device_names.emplace_back("qualcomm_qnn");
  ...
  std::string input_data_dir = FLAGS_data_dir + std::string("/ncf_input.txt");
  std::string output_data_dir = FLAGS_data_dir + std::string("/ncf_output.txt");

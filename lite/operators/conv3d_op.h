...
class Conv3DOpLite : public OpLite {
 public:
  Conv3DOpLite() {}

  explicit Conv3DOpLite(const std::string& type) : OpLite(type) {}
  ...
  std::string DebugString() const override { return "conv3d"; }

 protected:
  mutable Conv3DParam param_;

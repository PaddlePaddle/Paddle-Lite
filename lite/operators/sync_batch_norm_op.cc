...
#include "lite/operators/sync_batch_norm_op.h"
#include "lite/core/op_registry.h"
namespace paddle {
namespace lite {
namespace operators {

bool SyncBatchNormOp::CheckShape() const {
...
bool SyncBatchNormOp::InferShapeImpl() const {
  auto x_dims = param_.x->dims();
...
bool SyncBatchNormOp::AttachImpl(const cpp::OpDesc &op_desc, lite::Scope *scope) {
  AttachParam(&param_);
...
REGISTER_LITE_OP(sync_batch_norm, paddle::lite::operators::SyncBatchNormOp);

...
namespace paddle {
    namespace lite {
        namespace operators {
            ...
            /*bool FpgaConvOpLite::CheckShape() const {
            ...
            int FpgaConvOpLite::ConvOutputSize(int input_size,
                                      int filter_size,
                                      int dilation,
                                      int pad_left,
                                      int pad_right,
            ...
            void FpgaConvOpLite::UpdatePaddingAndDilation(std::vector<int> *paddings,

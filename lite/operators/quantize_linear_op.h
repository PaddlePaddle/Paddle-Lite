...
class QuantizeLinearOpLite : public OpLite {
 public:
  QuantizeLinearOpLite() {}

  explicit QuantizeLinearOpLite(const std::string &type) : OpLite(type) {}
  ...
  std::string DebugString() const override { return "quantize_linear"; }

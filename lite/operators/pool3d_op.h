...
class Pool3DOpLite : public OpLite {
 public:
  Pool3DOpLite() {}

  explicit Pool3DOpLite(const std::string &type) : OpLite(type) {}
  ...
  std::string DebugString() const override { return "pool3d"; }

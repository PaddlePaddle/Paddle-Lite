...
class UnbindOp : public OpLite {
 public:
  UnbindOp() {}
  explicit UnbindOp(const std::string &op_type) : OpLite(op_type) {}
  ...
  std::string DebugString() const override { return "unbind"; }

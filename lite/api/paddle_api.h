...
class LITE_API MobileConfig : public ConfigBase {
  ...
  int threads_{1};
  std::string model_buff_;
  std::string param_buff_;
 ...
 public:
  ...
  void set_model_buffer(const char* model_buffer,
    ...
    model_buff_ = std::string(model_buffer, model_buffer + model_buffer_size);
    param_buff_ = std::string(param_buffer, param_buffer + param_buffer_size);
  ...
  std::string model_buff() const { return model_buff_; }
  std::string param_buff() const { return param_buff_; }
};

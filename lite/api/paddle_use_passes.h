...
USE_MIR_PASS(nnadapter_op_fusion_pass);
USE_MIR_PASS(nnadapter_quantization_parameters_propagation_pass);
USE_MIR_PASS(nnadapter_restrict_quantized_op_with_same_input_output_scale_pass);
USE_MIR_PASS(nnadapter_quantization_parameters_removal_pass);

...
REGISTER_LITE_KERNEL(set_value,
    ...
    .BindInput("StepsTensorList",
               {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kAny))})
    .BindOutput("Out", {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kInt32))})
    .Finalize();
...
REGISTER_LITE_KERNEL(set_value,
    ...
    .BindInput("StepsTensorList",
               {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kAny))})
    .BindOutput("Out", {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kInt64))})
    .Finalize();
...
REGISTER_LITE_KERNEL(set_value,
                     ...
                     paddle::lite::kernels::host::SetValueCompute<int>,
                     bool)
    .BindInput("Input", {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kBool))})
    .BindInput("ValueTensor",
               {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kAny))})
    .BindInput("StartsTensorList",
               {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kAny))})
...
REGISTER_LITE_KERNEL(set_value,
                     ...
                     double)
    .BindInput("Input", {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kFP64))})
    .BindInput("ValueTensor",
               {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kAny))})
    .BindInput("StartsTensorList",
               {LiteType::GetTensorTy(TARGET(kHost), PRECISION(kAny))})

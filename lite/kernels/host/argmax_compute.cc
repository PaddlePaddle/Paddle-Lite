...
void ArgmaxCompute<T>::Run() {
  ...
  lite_metal::Tensor* input = param.X;
  ...
  switch (param.dtype) {
    ...
    case -1: {
      lite_metal::host::math::argmax_func<T, int64_t>(input, axis, output);
      break;
    }
    // static_cast<int>(lite_metal::core::FluidType::INT32) == 2
    case 2: {
      lite_metal::host::math::argmax_func<T, int32_t>(input, axis, output);
      break;
    }
    // static_cast<int>(lite_metal::core::FluidType::INT64) == 3
    case 3: {
      lite_metal::host::math::argmax_func<T, int64_t>(input, axis, output);
      break;
    }
...
REGISTER_LITE_KERNEL(arg_max,
                     ...
                     kAny,
                     kNCHW,
                     paddle::lite_metal::kernels::host::ArgmaxCompute<float>,
                     fp32)
...
REGISTER_LITE_KERNEL(arg_max,
                     ...
                     kAny,
                     kNCHW,
                     paddle::lite_metal::kernels::host::ArgmaxCompute<int64_t>,
                     int64)
...
REGISTER_LITE_KERNEL(arg_max,
                     ...
                     kAny,
                     kNCHW,
                     paddle::lite_metal::kernels::host::ArgmaxCompute<int32_t>,
                     int32)
...
REGISTER_LITE_KERNEL(arg_max,
                     ...
                     kAny,
                     kNCHW,
                     paddle::lite_metal::kernels::host::ArgmaxCompute<int16_t>,
                     int16)
...
REGISTER_LITE_KERNEL(arg_max,
                     ...
                     kAny,
                     kNCHW,
                     paddle::lite_metal::kernels::host::ArgmaxCompute<uint8_t>,
                     uint8)

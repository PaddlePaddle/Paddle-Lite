...
#ifndef LITE_KERNELS_METAL_IMAGE_OP_SPLIT_IMAGE_COMPUTE_H_
#define LITE_KERNELS_METAL_IMAGE_OP_SPLIT_IMAGE_COMPUTE_H_
...
#endif  // LITE_KERNELS_METAL_IMAGE_OP_SPLIT_IMAGE_COMPUTE_H_

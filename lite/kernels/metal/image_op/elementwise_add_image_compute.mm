...
void ElementwiseAddImageCompute::run_with_mps() {
	...
	if (mps_add_op_) {
		[((__bridge MPSCNNAdd *)mps_add_op_) encodeToCommandBuffer:cmdbuf
...
void ElementwiseAddImageCompute::setup_with_mps() {
	...
	mps_input_image_ = (__bridge_retained void *)[[MPSImage alloc] initWithTexture:input_buffer_x_->image() featureChannels:input_x_c];
	mps_input_image_y_ = (__bridge_retained void *)[[MPSImage alloc] initWithTexture:input_buffer_y_->image() featureChannels:input_y_c];

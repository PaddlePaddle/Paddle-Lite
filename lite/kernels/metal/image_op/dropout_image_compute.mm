...
typedef paddle::lite::kernels::metal::DropoutImageCompute<float, PRECISION(kFloat)> MetalDropoutFp32;
typedef paddle::lite::kernels::metal::DropoutImageCompute<MetalHalf, PRECISION(kFP16)> MetalDropoutFp16;

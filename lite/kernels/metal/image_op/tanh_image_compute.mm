...
template class paddle::lite::kernels::metal::
    TanhImageCompute<float, PRECISION(kFloat)>;
template class paddle::lite::kernels::metal::TanhImageCompute<MetalHalf,
                                                              PRECISION(kFP16)>;
typedef paddle::lite::kernels::metal::TanhImageCompute<float, PRECISION(kFloat)>
    MetalTanhFp32;
typedef paddle::lite::kernels::metal::TanhImageCompute<MetalHalf,
                                                       PRECISION(kFP16)>
    MetalTanhFp16;

REGISTER_LITE_KERNEL(
    tanh, kMetal, kFloat, kMetalTexture2DArray, MetalTanhFp32, def)
    .BindInput("X",
...
REGISTER_LITE_KERNEL(
    tanh, kMetal, kFP16, kMetalTexture2DArray, MetalTanhFp16, def)
    .BindInput("X",
               {LiteType::GetTensorTy(TARGET(kMetal),
                                      PRECISION(kFP16),
                                      DATALAYOUT(kMetalTexture2DArray))})

...
template class paddle::lite::kernels::metal::ElementwiseMaxImageCompute<MetalHalf, PRECISION(kFP16)>;

typedef paddle::lite::kernels::metal::ElementwiseMaxImageCompute<float, PRECISION(kFloat)> MetalElementwiseMaxFp32;
typedef paddle::lite::kernels::metal::ElementwiseMaxImageCompute<MetalHalf, PRECISION(kFP16)> MetalElementwiseMaxFp16;

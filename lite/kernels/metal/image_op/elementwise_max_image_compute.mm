...
REGISTER_LITE_KERNEL(
    elementwise_max, kMetal, kFloat, kMetalTexture2DArray, MetalElementwiseMaxFp32, def)
    .BindInput("X",
...
REGISTER_LITE_KERNEL(
    elementwise_max, kMetal, kFP16, kMetalTexture2DArray, MetalElementwiseMaxFp16, def)
    .BindInput(
        "X",

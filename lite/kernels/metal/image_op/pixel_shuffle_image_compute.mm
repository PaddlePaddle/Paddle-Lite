...
template class paddle::lite::kernels::metal::
    PixelShuffleImageCompute<float, PRECISION(kFloat)>;
template class paddle::lite::kernels::metal::
    PixelShuffleImageCompute<MetalHalf, PRECISION(kFP16)>;
typedef paddle::lite::kernels::metal::
    PixelShuffleImageCompute<float, PRECISION(kFloat)>
        MetalPixelShuffleFp32;
typedef paddle::lite::kernels::metal::PixelShuffleImageCompute<MetalHalf,
                                                               PRECISION(kFP16)>

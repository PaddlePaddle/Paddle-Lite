...
typedef paddle::lite::kernels::metal::BoxCoderImageCompute<float, PRECISION(kFloat)> MetalBoxCoderFp32;
typedef paddle::lite::kernels::metal::BoxCoderImageCompute<MetalHalf, PRECISION(kFP16)> MetalBoxCoderFp16;

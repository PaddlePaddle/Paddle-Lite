...
USE_SUBGRAPH_BRIDGE(transpose2, kRKNPU);
USE_SUBGRAPH_BRIDGE(norm, kRKNPU);
USE_SUBGRAPH_BRIDGE(reshape2, kRKNPU);

USE_SUBGRAPH_BRIDGE(sigmoid, kRKNPU);
USE_SUBGRAPH_BRIDGE(relu6, kRKNPU);
USE_SUBGRAPH_BRIDGE(pad2d, kRKNPU);

USE_SUBGRAPH_BRIDGE(scale, kRKNPU);

USE_SUBGRAPH_BRIDGE(flatten, kRKNPU);
USE_SUBGRAPH_BRIDGE(flatten2, kRKNPU);

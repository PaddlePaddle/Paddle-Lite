...
int ConvConverter(void* ctx, OpLite* op, KernelBase* kernel) {
  ...
  xtcl::Array<xtcl::xIndexExpr> xtcl_padding;
  xtcl_padding.push_back(paddings[0]);
  xtcl_padding.push_back(paddings[2]);
  xtcl_padding.push_back(paddings[1]);
  xtcl_padding.push_back(paddings[3]);
  conv_attrs->padding = std::move(xtcl::Array<xtcl::xIndexExpr>(xtcl_padding));
  ...
  conv_attrs->kernel_size =
      std::move(xtcl::Array<xtcl::xIndexExpr>(kernel_size));

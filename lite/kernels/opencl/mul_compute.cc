...
REGISTER_LITE_KERNEL(mul,
                     ...
                     kFloat,
                     kNHWC,
                     paddle::lite::kernels::opencl::MulComputeImage2DNHWC,
                     image2d)
    .BindInput("X",
...
// Comment buffer-opencl impl: pick kernel conflict
// REGISTER_LITE_KERNEL(
//    mul, kOpenCL, kFloat, kNCHW, paddle::lite::kernels::opencl::MulCompute,
//    def)

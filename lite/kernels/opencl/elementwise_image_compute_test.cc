...
template <class T>
void RunElementwiseCommonSize(
                             std::vector<int> x_shape_full,
  ...
  std::unique_ptr<KernelContext> context(new KernelContext);
  context->As<OpenCLContext>().InitOnce();
  const lite_api::CLPrecisionType p = paddle::lite_api::CLPrecisionType::CL_PRECISION_FP32;
  CLRuntime::Global()->set_precision(p);
  const bool fp16_flag = (p == lite_api::CLPrecisionType::CL_PRECISION_FP16);
  LOG(INFO) << "\n\t[  START  ] Test Precision="
            << lite_api::CLPrecisionTypeToStr(p);
  ...
  std::cout << "00: " << y_v[0] << " 111: " << y_v[1] << std::endl;
  //fill_data_rand(y_v.data(), -10.f, 10.f, y_dim.production());
  auto y_img_shape = default_convertor->InitImageDimInfoWith(y_dim);  // w, h
  std::vector<char> y_image_data(y_img_shape.production() * 4 *
                                 dtype_size);  // 4: RGBA
...
void test_elementwise_all_dim_data_gpu(){
  ...
  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {n, c, h, w}, {n, c, h, w}, {n, c, h, w}, {n, c, h, w}, 0);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {1, c, 1, 1}, {n, c, h, w}, {c}, {n, c, h, w}, 1);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {1, 1, h, 1}, {n, c, h, w}, {h}, {n, c, h, w}, 2);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {1, 1, 1, w}, {n, c, h, w}, {w}, {n, c, h, w}, -1);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {1, c, h, w}, {n, c, h, w}, {c, h, w}, {n, c, h, w}, -1);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {n, c, h, 1}, {n, c, h, w}, {n, c, h}, {n, c, h, w}, 0);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {n, c, 1, 1}, {n, c, h, w}, {n, c}, {n, c, h, w}, 0);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {1, c, h, 1}, {n, c, h, w}, {c, h}, {n, c, h, w}, 1);

  RunElementwiseCommonSize<float>(
      {n, c, h, w}, {1, 1, h, w}, {n, c, h, w}, {h, w}, {n, c, h, w}, -1);

  RunElementwiseCommonSize<float>(
      {n, c, h}, {n, c, h}, {n, c, h}, {n, c, h}, {n, c, h}, 0);

  RunElementwiseCommonSize<float>(
      {n, c, h}, {1, 1, h}, {n, c, h}, {h}, {n, c, h}, -1);

  RunElementwiseCommonSize<float>(
      {n, c, h}, {1, c, 1}, {n, c, h}, {c}, {n, c, h}, 1);

  RunElementwiseCommonSize<float>(
      {n, c, h}, {n, 1, 1}, {n, c, h}, {n}, {n, c, h}, 0);

  RunElementwiseCommonSize<float>(
      {n, c, h}, {n, c, 1}, {n, c, h}, {n, c}, {n, c, h}, 0);

  RunElementwiseCommonSize<float>(
      {n, c, h}, {1, c, h}, {n, c, h}, {c, h}, {n, c, h}, -1);
...
void test_elementwise_all_dim_data_cpu(){
  //test elementwise common size, only add compute, data in cpu
}
...
TEST(elementwise_broadcast, compute_basic) {
  ...
  //test elementwise all dims, only add compute, y data in cpu
  test_elementwise_all_dim_data_cpu();

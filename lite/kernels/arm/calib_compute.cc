...
void CalibComputeFp16ToFp32<DLType>::Run() {
  ...
  auto* dout = param.output->template mutable_data<float>();
  lite_metal::arm::math::fp16::fp16_to_fp32(din, dout, param.input->numel());
}
template <DataLayoutType DLType>
void CalibComputeFp32ToFp16<DLType>::Run() {
  ...
  lite_metal::arm::math::fp16::fp32_to_fp16(din, dout, param.input->numel());
}
#endif
...
REGISTER_LITE_KERNEL(
    ...
    kFP16,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeFp16ToFp32<DATALAYOUT(kNCHW)>,
    fp16_to_fp32)
...
REGISTER_LITE_KERNEL(
    ...
    kFP16,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeFp32ToFp16<DATALAYOUT(kNCHW)>,
    fp32_to_fp16)
    .BindInput("Input",
...
REGISTER_LITE_KERNEL(
    ...
    kInt8,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeFp32ToInt8<DATALAYOUT(kNCHW)>,
    fp32_to_int8)
    .BindInput("Input",
               {LiteType::GetTensorTy(TARGET(kARM), PRECISION(kFloat))})
...
REGISTER_LITE_KERNEL(
    ...
    kInt32,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeInt32ToFp32<DATALAYOUT(kNCHW)>,
    int32_to_fp32)
    .BindInput("Input",
...
REGISTER_LITE_KERNEL(
    ...
    kInt32,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeInt32ToInt64<DATALAYOUT(kNCHW)>,
    int32_to_int64)
    .BindInput("Input",
               {LiteType::GetTensorTy(TARGET(kARM), PRECISION(kInt32))})
...
REGISTER_LITE_KERNEL(
    ...
    kInt32,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeFp32ToInt32<DATALAYOUT(kNCHW)>,
    fp32_to_int32)
    .BindInput("Input",
               {LiteType::GetTensorTy(TARGET(kARM), PRECISION(kFloat))})
...
REGISTER_LITE_KERNEL(
    ...
    kInt64,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeInt64ToFp32<DATALAYOUT(kNCHW)>,
    int64_to_fp32)
    .BindInput("Input",
...
REGISTER_LITE_KERNEL(
    ...
    kInt8,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeInt8ToFp32<DATALAYOUT(kNCHW)>,
    int8_to_fp32)
...
REGISTER_LITE_KERNEL(
    ...
    kInt64,
    kNCHW,
    paddle::lite_metal::kernels::arm::CalibComputeInt64ToInt32<DATALAYOUT(kNCHW)>,
    int64_to_int32)
    .BindInput("Input",

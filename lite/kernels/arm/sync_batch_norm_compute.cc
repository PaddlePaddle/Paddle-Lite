...
#include "lite/kernels/arm/sync_batch_norm_compute.h"
...
void SyncBatchNormCompute::PrepareForRun() {
...
REGISTER_LITE_KERNEL(sync_batch_norm,
                     ...
                     kFloat,
                     kNCHW,
                     paddle::lite::kernels::arm::SyncBatchNormCompute,
                     def)

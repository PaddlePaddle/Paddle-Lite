...
void ConvCompute<PRECISION(kFloat), PRECISION(kFloat)>::PrepareForRun() {
  ...
  } else if (param.groups == 1 && kw == 3 && kh == 3 && stride == 1 &&
             ks_equal && no_dilation) {
...
void ConvCompute<PRECISION(kInt8), PRECISION(kFloat)>::PrepareForRun() {
  ...
  } else if (param.groups == 1 && kw == 3 && kh == 3 && sw == 1 &&
             no_dilation && pads_equal && !ctx.has_dot()) {
...
void ConvCompute<PRECISION(kFP16), PRECISION(kFP16)>::PrepareForRun() {
  ...
  } else if (param.groups == 1 && kw == 3 && kh == 3 && sw == 2 &&
             no_dilation && chin * chout < 4 * hin * win && ks_equal) {

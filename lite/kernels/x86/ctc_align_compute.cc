...
#include "lite/kernels/x86/ctc_align_compute.h"
#include <algorithm>
#include <cstring>
#include <map>
#include <utility>
...
using ctc_align_int64 =
    paddle::lite::kernels::x86::CtcAlignCompute<int64_t, PRECISION(kFloat)>;
REGISTER_LITE_KERNEL(ctc_align, kX86, kFloat, kNCHW, ctc_align_int64, int64)
    .BindInput("Input",
...
using ctc_align_int32 =
    paddle::lite::kernels::x86::CtcAlignCompute<int32_t, PRECISION(kFloat)>;
REGISTER_LITE_KERNEL(ctc_align, kX86, kFloat, kNCHW, ctc_align_int32, int32)
    .BindInput("Input",

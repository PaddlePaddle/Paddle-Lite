...
int ConvertPriorBox(Converter* converter, OpInfo* op, Scope* scope) {
  ...
  auto min_max_aspect_ratios_order = op->GetAttr<bool>("min_max_aspect_ratios_order");
  ...
  auto min_max_aspect_ratios_order_operand = converter->AddConstantOperand(min_max_aspect_ratios_order);      

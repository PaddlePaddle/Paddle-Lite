...
REGISTER_CONVERTER(
    fill_any_like,
    ConvertFillAnyLike,
    "huawei_ascend_npu,cambricon_mlu,intel_openvino,qualcomm_qnn");
...
REGISTER_CONVERTER(calib,
                   ConvertCalib,
                   "huawei_ascend_npu,cambricon_mlu,qualcomm_qnn");
...
REGISTER_CONVERTER(tile,
                   ConvertTile,
                   "huawei_ascend_npu,huawei_kirin_npu,qualcomm_qnn");
...
REGISTER_CONVERTER(yolo_box,
                   ConvertYoloBox,
                   "nvidia_tensorrt,cambricon_mlu,qualcomm_qnn,intel_openvino");
...
REGISTER_CONVERTER(multiclass_nms3,
                   ...
                   "cambricon_mlu,qualcomm_qnn,intel_openvino");
// Custom op

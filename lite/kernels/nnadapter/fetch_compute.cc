...
#include "lite/kernels/nnadapter/fetch_compute.h"
...
void FetchCompute::Run() {
  LOG(FATAL) << "Fetch op is only used for graph optimization and should not "
                "be called!";
}
...
REGISTER_LITE_KERNEL(fetch,
                     ...
                     kAny,
                     kNCHW,
                     paddle::lite::kernels::nnadapter::FetchCompute,
                     def)

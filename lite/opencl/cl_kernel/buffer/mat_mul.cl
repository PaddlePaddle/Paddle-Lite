...
__kernel void mat_mul(__global const CL_DTYPE* x, __global const CL_DTYPE* y, __global CL_DTYPE* out, const int M, const int N, const int K) {
...
__kernel void mat_mul(__global const CL_DTYPE* a, __global const CL_DTYPE* b, __global CL_DTYPE* c, const int M, const int N, const int K) {

...
inline const VariableDesc (&EnumValuesVariableDesc())[2] {
  static const VariableDesc values[] = {VariableDesc_NONE,
                                        VariableDesc_LoDTensorDesc};
  return values;
}

inline const char *const *EnumNamesVariableDesc() {
  static const char *const names[3] = {"NONE", "LoDTensorDesc", nullptr};
  return names;
}

inline const char *EnumNameVariableDesc(VariableDesc e) {
  if (flatbuffers::IsOutRange(e, VariableDesc_NONE, VariableDesc_LoDTensorDesc))
    return "";
...
template <typename T>
struct VariableDescTraits {
  static const VariableDesc enum_value = VariableDesc_NONE;
};

template <>
struct VariableDescTraits<paddle::lite::fbs::proto::ParamDesc_::LoDTensorDesc> {
...
struct VariableDescUnion {
  ...
  paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *AsLoDTensorDesc() {
    return type == VariableDesc_LoDTensorDesc
               ? reinterpret_cast<
                     paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *>(
                     value)
               : nullptr;
  }
  const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *AsLoDTensorDesc()
      const {
    return type == VariableDesc_LoDTensorDesc
               ? reinterpret_cast<const paddle::lite::fbs::proto::ParamDesc_::
                                      LoDTensorDescT *>(value)
               : nullptr;
  }
};

inline bool operator==(const VariableDescUnion &lhs,
                       const VariableDescUnion &rhs) {
  ...
  switch (lhs.type) {
    ...
    case VariableDesc_LoDTensorDesc: {
      return *(reinterpret_cast<
                 const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *>(
                 lhs.value)) ==
             *(reinterpret_cast<
                 const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *>(
                 rhs.value));
...
bool VerifyVariableDesc(flatbuffers::Verifier &verifier,
                        const void *obj,
                        VariableDesc type);
bool VerifyVariableDescVector(
...
inline bool operator==(const CombinedParamsDescT &lhs,
                       const CombinedParamsDescT &rhs) {
...
struct CombinedParamsDesc FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<
    ...
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>> *>(VT_PARAMS);
  }
  flatbuffers::Vector<flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>>
      *mutable_params() {
    return GetPointer<flatbuffers::Vector<
        flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>> *>(VT_PARAMS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_PARAMS) &&
           verifier.VerifyVector(params()) &&
           verifier.VerifyVectorOfTables(params()) && verifier.EndTable();
  }
  CombinedParamsDescT *UnPack(
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(
      CombinedParamsDescT *_o,
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<CombinedParamsDesc> Pack(
      flatbuffers::FlatBufferBuilder &_fbb,
      const CombinedParamsDescT *_o,
...
struct CombinedParamsDescBuilder {
  ...
  void add_params(
      flatbuffers::Offset<flatbuffers::Vector<
          flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>>> params) {
...
inline flatbuffers::Offset<CombinedParamsDesc> CreateCombinedParamsDesc(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<
        flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>>> params = 0) {
...
inline flatbuffers::Offset<CombinedParamsDesc> CreateCombinedParamsDescDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    std::vector<flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>>
        *params = nullptr) {
  auto params__ = params
                      ? _fbb.CreateVectorOfSortedTables<
                            paddle::lite::fbs::proto::ParamDesc>(params)
                      : 0;
  return paddle::lite::fbs::proto::CreateCombinedParamsDesc(_fbb, params__);
}

flatbuffers::Offset<CombinedParamsDesc> CreateCombinedParamsDesc(
    flatbuffers::FlatBufferBuilder &_fbb,
    const CombinedParamsDescT *_o,
    const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline bool operator==(const LoDTensorDescT &lhs, const LoDTensorDescT &rhs) {
  return (lhs.lod_level == rhs.lod_level) && (lhs.lod == rhs.lod) &&
         (lhs.dim == rhs.dim) && (lhs.data_type == rhs.data_type) &&
         (lhs.data == rhs.data);
}
...
struct LoDTensorDesc FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_LOD) && verifier.VerifyVector(lod()) &&
           VerifyOffset(verifier, VT_DIM) && verifier.VerifyVector(dim()) &&
...
struct LoDTensorDescBuilder {
  ...
  void add_data_type(paddle::lite::fbs::proto::VarType_::Type data_type) {
    fbb_.AddElement<int32_t>(
        LoDTensorDesc::VT_DATA_TYPE, static_cast<int32_t>(data_type), 0);
  }
...
inline flatbuffers::Offset<LoDTensorDesc> CreateLoDTensorDescDirect(
  ...
  return paddle::lite::fbs::proto::ParamDesc_::CreateLoDTensorDesc(
      _fbb, lod_level, lod__, dim__, data_type, data__);
}
...
struct VersionDescT : public flatbuffers::NativeTable {
  ...
  VersionDescT() : version(0), model_version(0) {}
};
...
struct VersionDesc FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  void UnPackTo(
      VersionDescT *_o,
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<VersionDesc> Pack(
      flatbuffers::FlatBufferBuilder &_fbb,
      const VersionDescT *_o,
      const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
flatbuffers::Offset<VersionDesc> CreateVersionDesc(
    flatbuffers::FlatBufferBuilder &_fbb,
    const VersionDescT *_o,
    const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct ParamDesc FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const paddle::lite::fbs::proto::ParamDesc_::VersionDesc *version() const {
    return GetPointer<
        const paddle::lite::fbs::proto::ParamDesc_::VersionDesc *>(VT_VERSION);
  }
  paddle::lite::fbs::proto::ParamDesc_::VersionDesc *mutable_version() {
    return GetPointer<paddle::lite::fbs::proto::ParamDesc_::VersionDesc *>(
        VT_VERSION);
  }
  ...
  paddle::lite::fbs::proto::ParamDesc_::VariableDesc variable_type() const {
    return static_cast<paddle::lite::fbs::proto::ParamDesc_::VariableDesc>(
        GetField<uint8_t>(VT_VARIABLE_TYPE, 0));
  }
  const void *variable() const { return GetPointer<const void *>(VT_VARIABLE); }
  template <typename T>
  const T *variable_as() const;
  const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDesc *
  variable_as_LoDTensorDesc() const {
    return variable_type() == paddle::lite::fbs::proto::ParamDesc_::
                                  VariableDesc_LoDTensorDesc
               ? static_cast<const paddle::lite::fbs::proto::ParamDesc_::
                                 LoDTensorDesc *>(variable())
               : nullptr;
  }
  void *mutable_variable() { return GetPointer<void *>(VT_VARIABLE); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_VERSION) &&
  ...
  void UnPackTo(
      ParamDescT *_o,
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<ParamDesc> Pack(
      flatbuffers::FlatBufferBuilder &_fbb,
      const ParamDescT *_o,
      const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
template <>
inline const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDesc *
ParamDesc::variable_as<paddle::lite::fbs::proto::ParamDesc_::LoDTensorDesc>()
    const {
...
struct ParamDescBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_version(flatbuffers::Offset<
                   paddle::lite::fbs::proto::ParamDesc_::VersionDesc> version) {
    fbb_.AddOffset(ParamDesc::VT_VERSION, version);
  }
  void add_name(flatbuffers::Offset<flatbuffers::String> name) {
    fbb_.AddOffset(ParamDesc::VT_NAME, name);
  }
  void add_variable_type(
      paddle::lite::fbs::proto::ParamDesc_::VariableDesc variable_type) {
    fbb_.AddElement<uint8_t>(
        ParamDesc::VT_VARIABLE_TYPE, static_cast<uint8_t>(variable_type), 0);
  }
  void add_variable(flatbuffers::Offset<void> variable) {
    fbb_.AddOffset(ParamDesc::VT_VARIABLE, variable);
  }
  explicit ParamDescBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<ParamDesc> CreateParamDesc(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc_::VersionDesc>
        version = 0,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    paddle::lite::fbs::proto::ParamDesc_::VariableDesc variable_type =
        paddle::lite::fbs::proto::ParamDesc_::VariableDesc_NONE,
...
inline flatbuffers::Offset<ParamDesc> CreateParamDescDirect(
  ...
  return paddle::lite::fbs::proto::CreateParamDesc(
      _fbb, version, name__, variable_type, variable);
}

flatbuffers::Offset<ParamDesc> CreateParamDesc(
    flatbuffers::FlatBufferBuilder &_fbb,
    const ParamDescT *_o,
    const flatbuffers::rehasher_function_t *_rehasher = nullptr);

inline CombinedParamsDescT *CombinedParamsDesc::UnPack(
    const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<paddle::lite::fbs::proto::CombinedParamsDescT> _o =
      std::unique_ptr<paddle::lite::fbs::proto::CombinedParamsDescT>(
          new CombinedParamsDescT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void CombinedParamsDesc::UnPackTo(
    CombinedParamsDescT *_o,
    const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = params();
    if (_e) {
      _o->params.resize(_e->size());
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->params[_i] = std::unique_ptr<paddle::lite::fbs::proto::ParamDescT>(
...
inline flatbuffers::Offset<CombinedParamsDesc> CombinedParamsDesc::Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const CombinedParamsDescT *_o,
...
inline flatbuffers::Offset<CombinedParamsDesc> CreateCombinedParamsDesc(
  ...
  struct _VectorArgs {
    ...
    const CombinedParamsDescT *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = {&_fbb, _o, _rehasher};
  (void)_va;
  auto _params = _fbb.CreateVector<
      flatbuffers::Offset<paddle::lite::fbs::proto::ParamDesc>>(
      _o->params.size(),
      [](size_t i, _VectorArgs *__va) {
        return CreateParamDesc(
            *__va->__fbb, __va->__o->params[i].get(), __va->__rehasher);
      },
      &_va);
  return paddle::lite::fbs::proto::CreateCombinedParamsDesc(_fbb, _params);
}
...
inline LoDTensorDescT *LoDTensorDesc::UnPack(
    const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT> _o =
      std::unique_ptr<paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT>(
          new LoDTensorDescT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline flatbuffers::Offset<LoDTensorDesc> CreateLoDTensorDesc(
  ...
  return paddle::lite::fbs::proto::ParamDesc_::CreateLoDTensorDesc(
      _fbb, _lod_level, _lod, _dim, _data_type, _data);
}

inline VersionDescT *VersionDesc::UnPack(
    const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<paddle::lite::fbs::proto::ParamDesc_::VersionDescT> _o =
      std::unique_ptr<paddle::lite::fbs::proto::ParamDesc_::VersionDescT>(
          new VersionDescT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void VersionDesc::UnPackTo(
    VersionDescT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = version();
...
inline flatbuffers::Offset<VersionDesc> VersionDesc::Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const VersionDescT *_o,
    const flatbuffers::rehasher_function_t *_rehasher) {
...
inline flatbuffers::Offset<VersionDesc> CreateVersionDesc(
  ...
  return paddle::lite::fbs::proto::ParamDesc_::CreateVersionDesc(
      _fbb, _version, _model_version);
}

}  // namespace ParamDesc_

inline ParamDescT *ParamDesc::UnPack(
    const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<paddle::lite::fbs::proto::ParamDescT> _o =
      std::unique_ptr<paddle::lite::fbs::proto::ParamDescT>(new ParamDescT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void ParamDesc::UnPackTo(
    ParamDescT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = version();
  ...
  }
  {
    ...
    if (_e)
      _o->variable.value =
          paddle::lite::fbs::proto::ParamDesc_::VariableDescUnion::UnPack(
              _e, variable_type(), _resolver);
  }
}

inline flatbuffers::Offset<ParamDesc> ParamDesc::Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const ParamDescT *_o,
    const flatbuffers::rehasher_function_t *_rehasher) {
...
inline flatbuffers::Offset<ParamDesc> CreateParamDesc(
  ...
  struct _VectorArgs {
    flatbuffers::FlatBufferBuilder *__fbb;
    const ParamDescT *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = {&_fbb, _o, _rehasher};
  (void)_va;
  auto _version =
      _o->version ? CreateVersionDesc(_fbb, _o->version.get(), _rehasher) : 0;
  auto _name = _fbb.CreateString(_o->name);
  auto _variable_type = _o->variable.type;
  auto _variable = _o->variable.Pack(_fbb);
  return paddle::lite::fbs::proto::CreateParamDesc(
      _fbb, _version, _name, _variable_type, _variable);
}

namespace ParamDesc_ {

inline bool VerifyVariableDesc(flatbuffers::Verifier &verifier,
                               const void *obj,
                               VariableDesc type) {
  switch (type) {
    case VariableDesc_NONE: {
    ...
    case VariableDesc_LoDTensorDesc: {
      auto ptr = reinterpret_cast<
          const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDesc *>(obj);
...
inline bool VerifyVariableDescVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<uint8_t> *types) {
...
inline void *VariableDescUnion::UnPack(
    const void *obj,
    VariableDesc type,
    const flatbuffers::resolver_function_t *resolver) {
  switch (type) {
...
inline flatbuffers::Offset<void> VariableDescUnion::Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
    const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case VariableDesc_LoDTensorDesc: {
      auto ptr = reinterpret_cast<
          const paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *>(value);
...
inline VariableDescUnion::VariableDescUnion(const VariableDescUnion &u)
    : type(u.type), value(nullptr) {
  switch (type) {
    case VariableDesc_LoDTensorDesc: {
      value = new paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT(
          *reinterpret_cast<
              paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *>(u.value));
      break;
    }
    default:
      break;
...
inline void VariableDescUnion::Reset() {
  switch (type) {
    case VariableDesc_LoDTensorDesc: {
      auto ptr = reinterpret_cast<
          paddle::lite::fbs::proto::ParamDesc_::LoDTensorDescT *>(value);
      delete ptr;
      break;
    }
    default:
...
inline const flatbuffers::TypeTable *VariableDescTypeTable() {
  ...
  static const char *const names[] = {"NONE", "LoDTensorDesc"};
...
inline const flatbuffers::TypeTable *CombinedParamsDescTypeTable() {
  ...
  static const char *const names[] = {"params"};
  static const flatbuffers::TypeTable tt = {
...
inline const flatbuffers::TypeTable *LoDTensorDescTypeTable() {
  ...
  static const char *const names[] = {
      "lod_level", "lod", "dim", "data_type", "data"};
  static const flatbuffers::TypeTable tt = {
...
inline const flatbuffers::TypeTable *VersionDescTypeTable() {
  ...
  static const char *const names[] = {"version", "model_version"};
  static const flatbuffers::TypeTable tt = {
...
inline const flatbuffers::TypeTable *ParamDescTypeTable() {
  ...
  static const char *const names[] = {
      "version", "name", "variable_type", "variable"};
  static const flatbuffers::TypeTable tt = {
      flatbuffers::ST_TABLE, 4, type_codes, type_refs, nullptr, names};
  return &tt;
}

inline const paddle::lite::fbs::proto::CombinedParamsDesc *
GetCombinedParamsDesc(const void *buf) {
  return flatbuffers::GetRoot<paddle::lite::fbs::proto::CombinedParamsDesc>(
      buf);
}

inline const paddle::lite::fbs::proto::CombinedParamsDesc *
GetSizePrefixedCombinedParamsDesc(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<
      paddle::lite::fbs::proto::CombinedParamsDesc>(buf);
}
...
inline bool VerifyCombinedParamsDescBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<paddle::lite::fbs::proto::CombinedParamsDesc>(
      nullptr);
}
...
inline bool VerifySizePrefixedCombinedParamsDescBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier
      .VerifySizePrefixedBuffer<paddle::lite::fbs::proto::CombinedParamsDesc>(
          nullptr);
}
...
inline std::unique_ptr<paddle::lite::fbs::proto::CombinedParamsDescT>
UnPackCombinedParamsDesc(
    const void *buf, const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<paddle::lite::fbs::proto::CombinedParamsDescT>(
      GetCombinedParamsDesc(buf)->UnPack(res));
}

inline std::unique_ptr<paddle::lite::fbs::proto::CombinedParamsDescT>
UnPackSizePrefixedCombinedParamsDesc(
    const void *buf, const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<paddle::lite::fbs::proto::CombinedParamsDescT>(
      GetSizePrefixedCombinedParamsDesc(buf)->UnPack(res));
}

...
struct VectorIterator {
  ...
  VectorIterator(pointer data, uint32_t i)
...
class Span {
 public:
  ...
  iterator rbegin() const noexcept { return reverse_iterator(end() - 1); }
  iterator rend() const noexcept { return reverse_iterator(begin() - 1); }

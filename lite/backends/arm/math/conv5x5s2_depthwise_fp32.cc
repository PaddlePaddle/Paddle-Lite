...
#define COMPUTE_FIVE_LINE_S2_OUT2_1                    \
  "ld2 {v9.4s, v10.4s}, [%[din_ptr0]], #32\n"          \
  "ld1 {v15.4s}, [%[bias]]\n"                          \
  "ld1 {v17.4s}, [%[bias]]\n"                          \
  "ld1 {v11.4s},  [%[din_ptr0]]\n"     /*891011*/      \
...
inline void compute_all_padding_pre(float* dout,
 ...
 LOG(INFO) << "data: " << din_ptr_arr[0][0] << ", " << din_ptr_arr[0][1] << ", " << din_ptr_arr[0][2] << ", " << din_ptr_arr[0][3];
 LOG(INFO) << "----";
 asm volatile(
     "ld1 {v11.4s}, [%[din_ptr]]\n"
     "ld1 {v14.4s}, [%[din_ptr]]\n"

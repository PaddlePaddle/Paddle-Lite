...
template <typename T>
inline void reduce_min_n(const T* src,
                         T* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <typename T>
inline void reduce_min_c(const T* src,
                         T* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <typename T>
inline void reduce_min_all_of_three(
...
template <typename T>
inline void reduce_min_first_of_three(
    const T* src, T* dst, int first_in, int second_in, int third_in) {
...
template <typename T>
inline void reduce_min_second_of_three(
    const T* src, T* dst, int first_in, int second_in, int third_in) {
...
template <typename T>
inline void reduce_min_third_of_three(
    const T* src, T* dst, int first_in, int second_in, int third_in) {
  for (int i = 0; i < first_in; i++) {
...
template <typename T>
inline void reduce_min_h(const T* src,
                         T* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <typename T>
inline void reduce_min_w(const T* src,
                         T* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <typename T>
inline void reduce_min_nc(const T* src,
                          T* dst,
                          int num_in,
                          int channel_in,
                          int height_in,
...
template <typename T>
inline void reduce_min_ch(const T* src,
                          T* dst,
                          int num_in,
                          int channel_in,
                          int height_in,
...
template <typename T>
inline void reduce_min_hw(const T* src,
                          T* dst,
                          int num_in,
                          int channel_in,
                          int height_in,
...
template <typename T>
inline void reduce_min_all(const T* src,
                           T* dst,
                           int num_in,
                           int channel_in,
                           int height_in,

...
template <>
void reduce_min_n<float>(const float* src,
                         float* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <>
void reduce_min_first_of_three<float>(
...
template <>
void reduce_min_second_of_three<float>(
    const float* src, float* dst, int first_in, int second_in, int third_in) {
...
template <>
void reduce_min_third_of_three<float>(
    const float* src, float* dst, int first_in, int second_in, int third_in) {
  for (int i = 0; i < first_in; i++) {
...
template <>
void reduce_min_all_of_three<float>(
    const float* src, float* dst, int first_in, int second_in, int third_in) {
  float min = src[0];
...
template <>
void reduce_min_c<float>(const float* src,
                         float* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <>
void reduce_min_h<float>(const float* src,
                         float* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <>
void reduce_min_w<float>(const float* src,
                         float* dst,
                         int num_in,
                         int channel_in,
                         int height_in,
...
template <>
void reduce_min_all<float>(const float* src,
                           float* dst,
                           int num_in,
                           int channel_in,
                           int height_in,
...
template <>
void reduce_min_nc<float>(const float* src,
                          float* dst,
                          int num_in,
                          int channel_in,
                          int height_in,
...
template <>
void reduce_min_ch<float>(const float* src,
                          float* dst,
                          int num_in,
                          int channel_in,
                          int height_in,
...
template <>
void reduce_min_hw<float>(const float* src,
                          float* dst,
                          int num_in,
                          int channel_in,
                          int height_in,

...
#define INIT                           \
  "2:\n"                               \
  "vld1.16 {d16-d19}, [%[ptr_out0]]!\n"\
  "vld1.16 {d6-d7}, [%[r0]]!\n"        \
  "vldr d10, [%[wc], #0x30]\n"         \
  "vldr d11, [%[wc], #0x38]\n"         \
  "vld1.16 {d20-d23}, [%[ptr_out0]]!\n"\
  "vldr d12, [%[wc], #0x40]\n"         \
  "vldr d13, [%[wc], #0x48]\n"         \
  "vld1.16 {d4}, [%[r0]]\n"            \
  "vld1.16 {d24-d27}, [%[ptr_out0]]!\n"\
  "vmla.f16 q8,  %q[w0], d6[0]\n"     \
  "vmla.f16 q9,  %q[w0], d6[1]\n"     \
  "vld1.16 {d28-d31}, [%[ptr_out0]]\n" \
...
#define COMPUTE                        \
  ...
  "vmla.f16 q12, q7, d7[2]\n"          \
  "vmla.f16 q13, q7, d7[3]\n"          \
  "vst1.16  {d16-d19}, [%[ptr_out0]]!\n"\
  "subs %[cnt], #1\n"                  \
  "vmla.f16 q14, q7, d4[0]\n"          \
  "vmla.f16 q15, q7, d4[1]\n"          \
  "vst1.16  {d20-d23}, [%[ptr_out0]]!\n"\

...
//           const float* din_ch = din_batch + c * size_channel_in;  // in
//           address
//           float tmp1 = din_ch[0];
...
//       }
// #endif  //  __aarch64__
//       float32x2_t vmax_tmp = vmax_f32(vget_low_f32(vmax),
//       vget_high_f32(vmax));
...
//         max_tmp = max_tmp > data_in_channel[0] ? max_tmp :
//         data_in_channel[0];
//         data_in_channel++;
//       }
...
//       }
// #endif  //  __aarch64__
//       float32x2_t vsum_tmp = vadd_f32(vget_low_f32(vsum),
//       vget_high_f32(vsum));
...
//               "dr1, 0-7\n"
//               "vmax.f32  q4, q0, q1                           @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r0\n"
//               "vmax.f32  q5, q2, q3                           @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r1\n"
...
//               "vld2.f32  {d4-d7}, [%[dr1]]!                   @ load d4-d7, "
//               "dr1, 0-7\n"
//               "vadd.f32  q4, q0, q1                           @ add 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r0\n"
//               "vadd.f32  q5, q2, q3                           @ add 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r1\n"
...
//               "
//               "dr2, 0-7\n"
//               "vld1.f32  {d12}, [%[dr0]]                      @ load d12,
//               dr0, "
//               "8,9\n"
//               "vld1.f32  {d14}, [%[dr1]]                      @ load d14,
//               dr1, "
//               "8,9\n"
//               "vld1.f32  {d16}, [%[dr2]]                      @ load d16,
//               dr2, "
//               "8,9\n"
//               "vmax.f32  q9, q0, q1                           @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r0\n"
//               "vmax.f32  q10, q2, q3                          @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r1\n"
//               "vmax.f32  q11, q4, q5                          @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r2\n"
...
//               dr2, "
//               "8,9\n"
//               "vadd.f32  q9, q0, q1                           @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r0\n"
//               "vadd.f32  q10, q2, q3                          @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r1\n"
//               "vadd.f32  q11, q4, q5                          @ max 0, 2, 4,
//               6 "
//               "and 1, 3, 5, 7, r2\n"
//               "vext.f32  q0, q0, q6, #1                       @ vext 2, 4, 6,
//               "
      ...
      for (int h = 0; h < hout; h++) {
        ...
        if (w_unroll_size > 0) {
          ...
          asm volatile(
              ...
              "\n"
              "vext.f32  q1, q0, q6, #1                       @ vext 2, 4, 6, "
              "\n"
              "vext.f32  q3, q2, q7, #1                       @ vext 2, 4, 6, "
              "\n"
              "vext.f32  q5, q4, q8, #1                       @ vext 2, 4, 6, "
              "\n"

              "vmax.f32  q6, q9, q1                           @ max\n"
              "vmax.f32  q7, q10, q3                          @ max\n"
              "vmax.f32  q8, q11, q5                          @ max\n"

              "vmax.f32 q9, q6, q7                            @ max reduce\n"
              "vld2.f32  {d0-d3}, [%[dr0]]!                   @ load d0-d3 \n"
              "vld2.f32  {d4-d7}, [%[dr1]]!                   @ load d4-d7 \n"
              "vld2.f32  {d8-d11}, [%[dr2]]!                  @ load d7-d11 \n"

              "vmax.f32 q10, q9, q8                            @ max reduce\n"
              "subs      %[cnt_num], #1                       @ subs cnt_num \n"
              "vld1.f32  {d12}, [%[dr0]]                      @ load d12, dr0 "
              "\n"
              "vld1.f32  {d14}, [%[dr1]]                      @ load d14, dr1 "
              ...
              "vst1.f32  {d20-d21}, [%[dr_out]]!                @ store 4 out "
              "\n"
              "bne       1b                                   @ bne "
              "s3_max_loop_mid\n"
              : [dr0] "+r"(dr0),
      ...
      for (int h = 0; h < hout; h++) {
        ...
        if (w_unroll_size > 0) {
          ...
          asm volatile(
              ...
              "fadd  v7.4s, v10.4s, v3.4s\n" /* max */
              "fadd  v8.4s, v11.4s, v5.4s\n" /* max */
          ...
          asm volatile(
              ...
              "vadd.f32  q6, q9, q1                           @ max\n"
              "vadd.f32  q7, q10, q3                          @ max\n"
              "vadd.f32  q8, q11, q5                          @ max\n"

              "vadd.f32 q9, q6, q7                            @ max reduce\n"
              "vld2.f32  {d0-d3}, [%[dr0]]!                   @ load d0-d3 \n"
              "vld2.f32  {d4-d7}, [%[dr1]]!                   @ load d4-d7  \n"

              "vadd.f32 q10, q9, q8                            @ max reduce\n"
              "vld2.f32  {d8-d11}, [%[dr2]]!                  @ load d7-d11  \n"
              "vld1.f32  {d12}, [%[dr0]]                      @ load d12,  \n"
              ...
              "vst1.f32  {d22-d23}, [%[dr_out]]!              @ store 4 out \n"
              "bne       1b                                   @ bne "
              "s3_max_loop_mid\n"
              : [dr0] "+r"(dr0),
                [dr1] "+r"(dr1),

...
void act_swish<float16_t>(
  ...
  LITE_PARALLEL_BEGIN(i, tid, threads) {
    ...
    for (; i + 31 < nums_per_thread; i += 32) {
      ...
      v_p0 = vdivq_f16(v_p0, vaddq_f16(vone, exp_ps(vnegq_f16(vmulq_f16(vbeta, v_p0)))));
      v_p1 = vdivq_f16(v_p1, vaddq_f16(vone, exp_ps(vnegq_f16(vmulq_f16(vbeta, v_p1)))));
      v_p2 = vdivq_f16(v_p2, vaddq_f16(vone, exp_ps(vnegq_f16(vmulq_f16(vbeta, v_p2)))));
      v_p3 = vdivq_f16(v_p3, vaddq_f16(vone, exp_ps(vnegq_f16(vmulq_f16(vbeta, v_p3)))));
    ...
    for (; i + 3 < nums_per_thread; i += 4) {
      ...
      v_p0 = vdiv_f16(v_p0, vadd_f16(_one, exp_ps(vneg_f16(vmul_f16(_beta, v_p0)))));

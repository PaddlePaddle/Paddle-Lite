...
ARM_DNN_LIBRARY_DLL_EXPORT LogMessage::LogMessage(const char* file,
                                                  const char* func,
                                                  int lineno,
                                                  const char* level)
    : level_(level) {
...
ARM_DNN_LIBRARY_DLL_EXPORT LogMessage::~LogMessage() {
  log_stream_ << '\n';
...
ARM_DNN_LIBRARY_DLL_EXPORT LogMessageFatal::~LogMessageFatal() noexcept(false) {
  log_stream_ << '\n';
#if ARM_DNN_LIBRARY_OS_ANDROID
  ANDROID_LOG_F(log_stream_.str().c_str());
#endif
...
ARM_DNN_LIBRARY_DLL_EXPORT VLogMessage::VLogMessage(const char* file,
                                                    const char* func,
                                                    int lineno,
...
ARM_DNN_LIBRARY_DLL_EXPORT VLogMessage::~VLogMessage() {

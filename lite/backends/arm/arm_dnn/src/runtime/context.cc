...
#include "arm_dnn/runtime/context.h"
#include "runtime/context.h"
#include "utilities/logging.h"

namespace arm_dnn {

ARM_DNN_THREAD_LOCAL void* Context::workspace_data_ = nullptr;
ARM_DNN_THREAD_LOCAL size_t Context::workspace_size_ = 0;

Context::Context(Device* device) : device_(device) {
  ARM_DNN_CHECK(device_);
  ARM_DNN_CHECK(device_->callback()->context_create);
...
Status Context::SetParam(ParamKey key, ParamValue value, bool force) {
  ...
  params_[key] = value;
  ARM_DNN_CHECK(device_);
  ARM_DNN_CHECK(device_->callback()->context_setparam);
...
ARM_DNN_DLL_EXPORT void* context_create(void* device) {
  if (!device) {
    return nullptr;
  }
...
ARM_DNN_DLL_EXPORT void context_destroy(void* context) {
  if (context) {
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<ParamValue>(void* context,
                                                       ParamKey key,
                                                       ParamValue value) {
  if (!context) {
    return INVALID_PARAMETER;
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<ParamValue>(void* context,
                                                       ParamKey key,
                                                       ParamValue* value) {
  if (!context) {
    return INVALID_PARAMETER;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<bool>(void* context,
                                                 ParamKey key,
                                                 bool value) {
  ParamValue v;
  v.b = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<int32_t>(void* context,
                                                    ParamKey key,
                                                    int32_t value) {
  ParamValue v;
  v.i32 = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<int64_t>(void* context,
                                                    ParamKey key,
                                                    int64_t value) {
  ParamValue v;
  v.i64 = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<size_t>(void* context,
                                                   ParamKey key,
                                                   size_t value) {
  ParamValue v;
  v.szt = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<float>(void* context,
                                                  ParamKey key,
                                                  float value) {
  ParamValue v;
  v.f32 = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<double>(void* context,
                                                   ParamKey key,
                                                   double value) {
  ParamValue v;
  v.f64 = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_setparam<void*>(void* context,
                                                  ParamKey key,
                                                  void* value) {
  ParamValue v;
  v.ptr = value;
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<bool>(void* context,
                                                 ParamKey key,
                                                 bool* value) {
  ParamValue v;
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<int32_t>(void* context,
                                                    ParamKey key,
                                                    int32_t* value) {
  ParamValue v;
  auto status = context_getparam(context, key, &v);
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<int64_t>(void* context,
                                                    ParamKey key,
                                                    int64_t* value) {
  ParamValue v;
  auto status = context_getparam(context, key, &v);
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<size_t>(void* context,
                                                   ParamKey key,
                                                   size_t* value) {
  ParamValue v;
  auto status = context_getparam(context, key, &v);
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<float>(void* context,
                                                  ParamKey key,
                                                  float* value) {
  ParamValue v;
  auto status = context_getparam(context, key, &v);
...
template <>
ARM_DNN_DLL_EXPORT Status context_getparam<double>(void* context,
                                                   ParamKey key,
                                                   double* value) {
  ParamValue v;
  auto status = context_getparam(context, key, &v);

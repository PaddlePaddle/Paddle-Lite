...
#define MUTABLE_DATA_GPU(tensor_ins_p, img_w, img_h, ptr)                      \
  (CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP16)        \
      ...
      : ((CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP32) \
             ? (tensor_ins_p)                                                  \
                   ->mutable_data<float, cl::Image2D>(img_w, img_h, ptr)       \
             : (tensor_ins_p)                                                  \
                   ->mutable_data<int8_t, cl::Image2D>(img_w, img_h, ptr))
...
#define DATA_GPU(tensor_ins_p)                                                 \
  (CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP16)        \
      ...
      : ((CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP32) \
             ...
             : (tensor_ins_p)->mutable_data<int8_t, cl::Image2D>())
...
#define GET_DATA_GPU(tensor_ins_p)                                             \
  (CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP16)        \
      ...
      : ((CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP32) \
             ...
             : (tensor_ins_p)->data<int8_t, cl::Image2D>())
...
#define MUTABLE_DATA_CPU(tensor_ins_p)                                         \
  (CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP16)        \
      ...
      : ((CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP32) \
             ...
             : static_cast<void *>((tensor_ins_p)->mutable_data<int8_t>()))
...
#define GET_BUFFER_GPU(tensor_ins_p)                                           \
  (CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP16)        \
      ...
      : ((CLRuntime::Global()->get_precision() == lite_api::CL_PRECISION_FP32) \
             ...
             : (tensor_ins_p)->data<int8_t, cl::Buffer>())

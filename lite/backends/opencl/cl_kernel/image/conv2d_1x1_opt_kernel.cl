...
__kernel void conv2d_1x1_mali(__read_only image2d_t input, __write_only image2d_t output, __global CL_DTYPE4 *weight,
                              #ifdef BIASE_CH
...
__kernel void conv2d_1x1_h1w5c1(
  ...
  for (int i = 0; i < input_c; ++i) {
    ...
    CL_DTYPE4 input0 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x0, in_pos_y));
    CL_DTYPE4 input1 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x1, in_pos_y));
    CL_DTYPE4 input2 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x2, in_pos_y));
    CL_DTYPE4 input3 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x3, in_pos_y));
    CL_DTYPE4 input4 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x4, in_pos_y));
...
__kernel void conv2d_1x1_h1w7c1(
  ...
  for (int i = 0; i < input_c; ++i) {
    ...
    CL_DTYPE4 input3 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x3, in_pos_y));
    CL_DTYPE4 input4 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x4, in_pos_y));
    CL_DTYPE4 input5 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x5, in_pos_y));
    CL_DTYPE4 input6 = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(i * input_width + in_pos_x6, in_pos_y));
...
__kernel void conv2d_1x1_h2w2c2(
  ...
  CL_DTYPE4 out_w0_h1_c0 = out_w0_h0_c0;
  CL_DTYPE4 out_w1_h1_c0 = out_w0_h0_c0;
  CL_DTYPE4 out_w0_h0_c1 = READ_IMG_TYPE(CL_DTYPE_CHAR, bias, SAMPLER, (int2)(out_c + 1, 0));
  ...
  for (int i = 0; i < input_c; ++i) {
    ...
    CL_DTYPE4 f2 = READ_IMG_TYPE(CL_DTYPE_CHAR, filter, SAMPLER, (int2)(out_c, (i << 2) + 2));
    CL_DTYPE4 f3 = READ_IMG_TYPE(CL_DTYPE_CHAR, filter, SAMPLER, (int2)(out_c, (i << 2) + 3));
    CL_DTYPE4 f4 = READ_IMG_TYPE(CL_DTYPE_CHAR, filter, SAMPLER, (int2)(out_c + 1, (i << 2)));
    CL_DTYPE4 f5 = READ_IMG_TYPE(CL_DTYPE_CHAR, filter, SAMPLER, (int2)(out_c + 1, (i << 2) + 1));
    CL_DTYPE4 f6 = READ_IMG_TYPE(CL_DTYPE_CHAR, filter, SAMPLER, (int2)(out_c + 1, (i << 2) + 2));
    CL_DTYPE4 f7 = READ_IMG_TYPE(CL_DTYPE_CHAR, filter, SAMPLER, (int2)(out_c + 1, (i << 2) + 3));
...
CL_DTYPE4 alpha0, alpha1, alpha2, alpha3, alpha4, alpha5, alpha6, alpha7;
  ...
  alpha2 = alpha0;
  alpha3 = alpha0;
  alpha4 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)(out_c + 1, 0));
  alpha5 = alpha4;
  alpha6 = alpha4;
  alpha7 = alpha4;
  //}
  ...
  alpha4 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)((out_c + 1) * old_w + out_w, out_nh));
  if (out_w + 1 < output_width) {
    alpha5 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)((out_c + 1) * old_w + out_w + 1, out_nh));    
  }
  if (out_nh + 1 < output_height) {
    alpha6 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)((out_c + 1) * old_w + out_w, out_nh + 1));
  }
  if (out_w + 1 < output_width && out_nh + 1 < output_height) {
    alpha7 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)((out_c + 1) * old_w + out_w + 1, out_nh + 1));
  }
  //}
#elif defined(PRELU_ALL) //{
  alpha0   = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)(0, 0));
  ...
  {
    WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)((out_c + 1) * old_w + out_w, out_nh), out_w0_h0_c1);
    if (out_w + 1 < output_width) {
        WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)((out_c + 1) * old_w + out_w + 1, out_nh), out_w1_h0_c1);
    }
    if (out_nh + 1 < output_height) {
        WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)((out_c + 1) * old_w + out_w, out_nh + 1), out_w0_h1_c1);
    }
    if (out_w + 1 < output_width && out_nh + 1 < output_height) {
        WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)((out_c + 1) * old_w + out_w + 1, out_nh + 1), out_w1_h1_c1);
    }
  }
}
 ...
 __kernel void conv2d_1x1_mali_h1w2c1(
 ...
 #ifdef BIASE_CH
   CL_DTYPE4 output_w0 = READ_IMG_TYPE(CL_DTYPE_CHAR, bias, SAMPLER, (int2)(out_c, 0));
   ...
   for (int i = 0; i < input_c; ++i) {
     ...
     CL_DTYPE4 input_w1  = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(pos_in_w1_x, pos_in_y));
 ...
 CL_DTYPE4 alpha0,alpha1,alpha2,alpha3;
   ...
   //}
 #elif defined(PRELU_ELE) //{
   alpha0 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)(out_pos_w0_x, out_pos_y));
   if (out_w + 1 < output_width) {
     alpha1 =  READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)(out_pos_w1_x, out_pos_y));
   }
   //}
 #elif defined(PRELU_ALL) //{
   alpha0 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)(0, 0));
   ...
   if (out_w0 < old_w) {
     WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)(out_pos_w0_x, out_pos_y), output_w0);
   }

   if (out_w1 < old_w) {
     WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)(out_pos_w1_x, out_pos_y), output_w1);
   }
 }
 ...
 #ifdef BIASE_CH
   CL_DTYPE4 output_w0_c0 = READ_IMG_TYPE(CL_DTYPE_CHAR, bias, SAMPLER, (int2)(out_c, 0));
   CL_DTYPE4 output_w1_c0 = output_w0_c0;
   CL_DTYPE4 output_w0_c1 = READ_IMG_TYPE(CL_DTYPE_CHAR, bias, SAMPLER, (int2)(out_c + 1, 0));
 ...
 CL_DTYPE4 alpha0,alpha1,alpha2,alpha3;
   ...
   alpha2 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)((out_c + 1) * old_w + out_w, out_nh));
   if (out_w + 1 < output_width) {
     alpha3 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)((out_c + 1) * old_w + out_w + 1, out_nh));    
   }
   //}
 #elif defined(PRELU_ALL) //{
   alpha0 = READ_IMG_TYPE(CL_DTYPE_CHAR, prelu_alpha, SAMPLER, (int2)(0, 0));
   ...
   if(out_c >= global_size_dim0) return;
   {
     WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)(out_c * old_w + out_w, out_nh), output_w0_c0);
     if (out_w + 1 < old_w) {
       WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)(out_c * old_w + out_w + 1, out_nh), output_w1_c0);
     }
   }
   if(out_c + 1 >= global_size_dim0) return;
   {
     WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)((out_c + 1) * old_w + out_w, out_nh), output_w0_c1);
     if (out_w + 1 < old_w) {
       WRITE_IMG_TYPE(CL_DTYPE_CHAR, output_image, (int2)((out_c + 1) * old_w + out_w + 1, out_nh), output_w1_c1);
     }
   }
 }
 ...
 __kernel void conv2d_1x1_mali_h2w2c2(
   ...
   for (int i = 0; i < input_c; ++i) {
     ...
     CL_DTYPE4 input_w0_h1  = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(pos_in_w0_x, pos_in_h1_y));
     CL_DTYPE4 input_w1_h0  = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(pos_in_w1_x, pos_in_h0_y));
     CL_DTYPE4 input_w1_h1  = READ_IMG_TYPE(CL_DTYPE_CHAR, input_image, SAMPLER, (int2)(pos_in_w1_x, pos_in_h1_y));

...
// filter: OIHW2OHWIOgroupI4O4
__kernel void Conv2D_H2W1C1(__read_only image2d_t input, __write_only image2d_t output, __global half4 *weight,
                            #ifdef BIASE_CH
                            __global half4 *bias,
                            #endif
                            __private const int4 input_shape, __private const int4 output_shape,
...
// filter: OIHW2OHWIOgroupI4O4
__kernel void Conv2D_H2W1C2(__read_only image2d_t input, __write_only image2d_t output, __global half4 *weight,
                            #ifdef BIASE_CH
                            __global half4 *bias,
                            #endif
                            __private const int4 input_shape, __private const int4 output_shape,

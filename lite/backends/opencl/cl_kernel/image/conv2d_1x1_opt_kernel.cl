...
/*
    output_w0 = mad(input_w0.x, weight_ptr[0], output_w0);
    output_w0 = mad(input_w0.y, weight_ptr[1], output_w0);
    output_w0 = mad(input_w0.z, weight_ptr[2], output_w0);
    output_w0 = mad(input_w0.w, weight_ptr[3], output_w0);
    
    output_w1 = mad(input_w1.x, weight_ptr[0], output_w1);
    output_w1 = mad(input_w1.y, weight_ptr[1], output_w1);
    output_w1 = mad(input_w1.z, weight_ptr[2], output_w1);
    output_w1 = mad(input_w1.w, weight_ptr[3], output_w1);
*/
...
CL_DTYPE4 alpha0,alpha1,alpha2,alpha3;
  ...
  output_w0_c1 = activation_type4(output_w0_c1, alpha0);
  output_w1_c1 = activation_type4(output_w1_c1, alpha1);

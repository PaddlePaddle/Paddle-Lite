...
__kernel void transpose_4d_perm1023(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm1032(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm1203(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm1230(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm1302(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm1320(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm2013(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm2031(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm2103(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm2130(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm2301(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm2310(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm3012(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm3021(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm3102(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm3120(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm3201(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,
...
__kernel void transpose_4d_perm3210(__read_only image2d_t input_image,
                                    __write_only image2d_t output_image,
                                    __private const int out_C,
                                    __private const int out_H,
                                    __private const int out_W,

...
__kernel void adreno_gemm_4x4(__global const CL_DTYPE* a,
  ...
  CL_COMPUTE_DTYPE4 alpha0 = (CL_COMPUTE_DTYPE4)0.f;
  c_v16.s0123 = activation_type4(c_v16.s0123, alpha0);
  c_v16.s4567 = activation_type4(c_v16.s4567, alpha0);
  c_v16.s89ab = activation_type4(c_v16.s89ab, alpha0);
  c_v16.scdef = activation_type4(c_v16.scdef, alpha0);
...
__kernel void adreno_gemv_1x4(__global const CL_DTYPE* a,
  ...
  CL_COMPUTE_DTYPE4 alpha0 = (CL_COMPUTE_DTYPE4)0.f;
  c_v4 = activation_type4(c_v4, alpha0);

...
kernel void expand(texture2d_array<float, access::sample> inTexture [[texture(0)]],
    ...
    if (pm.fast == 1) {
        ...
        outTexture.write(float4(input1[c1 % 4], input2[c2 % 4], input3[c3 % 4], input4[c4 % 4]), gid.xy, gid.z);
    }
}
...
kernel void expand_half(texture2d_array<half, access::sample> inTexture [[texture(0)]],
    ...
    if (pm.fast == 1) {
        ...
        outTexture.write(half4(input1[c1 % 4], input2[c2 % 4], input3[c3 % 4], input4[c4 % 4]), gid.xy, gid.z);
    }
}

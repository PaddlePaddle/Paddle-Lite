...
kernel void softmax(texture2d_array<ftype, access::read> inTexture
                    [[texture(0)]],
  ...
  ftype sum_value =
      sum_vector[0] + sum_vector[1] + sum_vector[2] + sum_vector[3];
...
kernel void softmax2(texture2d_array<ftype, access::read> inTexture
                     [[texture(0)]],
                     texture2d_array<ftype, access::write> outTexture
                     [[texture(1)]],
                     constant SoftmaxParam &sp [[buffer(0)]],
...
kernel void softmax_c_d3_common(texture2d_array<ftype, access::read> inTexture
                                [[texture(0)]],
                                texture2d_array<ftype, access::write> outTexture
                                [[texture(1)]],
  ...
  ftype4 temp_value_vector =
      inTexture.read(uint2(gid.x, gid.y), array_size - 1);
...
kernel void softmax_w_d3_common(texture2d_array<ftype, access::read> inTexture
                                [[texture(0)]],
                                texture2d_array<ftype, access::write> outTexture
                                [[texture(1)]],
                                constant SoftmaxParam2 &sp [[buffer(0)]],
...
kernel void softmax_h_d3_common(texture2d_array<ftype, access::read> inTexture
                                [[texture(0)]],
                                texture2d_array<ftype, access::write> outTexture
                                [[texture(1)]],
                                constant SoftmaxParam2 &sp [[buffer(0)]],
...
kernel void softmax_h_2d_common(texture2d_array<ftype, access::read> inTexture
                                [[texture(0)]],
                                texture2d_array<ftype, access::write> outTexture
                                [[texture(1)]],
                                constant SoftmaxParam2 &sp [[buffer(0)]],
...
kernel void softmax_w_2d_common(texture2d_array<ftype, access::read> inTexture
                                [[texture(0)]],
                                texture2d_array<ftype, access::write> outTexture
                                [[texture(1)]],
                                constant SoftmaxParam2 &sp [[buffer(0)]],
  ...
  ftype4 sum_vector_left = 0.0;
  ftype4 temp_value_vector_left =
      inTexture.read(uint2((sp.W + 3) / 4, gid.y), 0);
  sum_vector_left += exp(temp_value_vector_left - max_value);

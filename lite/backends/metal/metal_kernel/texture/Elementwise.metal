...
kernel void elementwise_add(texture2d_array<ftype, access::read> inputX
                            [[texture(0)]],
...
kernel void elementwise_sub(texture2d_array<ftype, access::read> inputX
                            [[texture(0)]],
                            texture2d_array<ftype, access::read> inputY
                            [[texture(1)]],
                            texture2d_array<ftype, access::write> outTexture
...
kernel void elementwise_mul(texture2d_array<ftype, access::read> inputX
                            [[texture(0)]],
                            texture2d_array<ftype, access::read> inputY
                            [[texture(1)]],
                            texture2d_array<ftype, access::write> outTexture

...
kernel void elementwise_sub(texture2d_array<float, access::read> inputX [[texture(0)]],
                            texture2d_array<float, access::read> inputY [[texture(1)]],
                            texture2d_array<float, access::write> outTexture [[texture(2)]],
...
kernel void elementwise_sub_half(texture2d_array<half, access::read> inputX [[texture(0)]],
                                 texture2d_array<half, access::read> inputY [[texture(1)]],
                                 texture2d_array<half, access::write> outTexture [[texture(2)]],
                                 constant ElementwiseParam &pm [[buffer(0)]],
                                 uint3 gid [[thread_position_in_grid]]) {
...
kernel void elementwise_mul(texture2d_array<float, access::read> inputX [[texture(0)]],
                            texture2d_array<float, access::read> inputY [[texture(1)]],
                            texture2d_array<float, access::write> outTexture [[texture(2)]],
                            constant ElementwiseParam &pm [[buffer(0)]],
                            uint3 gid [[thread_position_in_grid]]) {
...
kernel void elementwise_mul_half(texture2d_array<half, access::read> inputX [[texture(0)]],
                                 texture2d_array<half, access::read> inputY [[texture(1)]],
                                 texture2d_array<half, access::write> outTexture [[texture(2)]],
                                 constant ElementwiseParam &pm [[buffer(0)]],
                                 uint3 gid [[thread_position_in_grid]]) {

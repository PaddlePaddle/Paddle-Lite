...
kernel void prelu_channel(texture2d_array<float, access::sample> inTexture
                          [[texture(0)]],
...
kernel void prelu_element(texture2d_array<float, access::sample> inTexture
                          [[texture(0)]],
                          texture2d_array<float, access::write> outTexture
                          [[texture(1)]],
                          const device float4 *alpha [[buffer(0)]],
  ...
  int alpha_to =
      (gid.y * inTexture.get_width() + gid.x) * inTexture.get_array_size();
...
kernel void prelu_other(texture2d_array<float, access::sample> inTexture
                        [[texture(0)]],
                        texture2d_array<float, access::write> outTexture
                        [[texture(1)]],
...
kernel void prelu_channel_half(texture2d_array<half, access::sample> inTexture
                               [[texture(0)]],
...
kernel void prelu_element_half(texture2d_array<half, access::sample> inTexture
                               [[texture(0)]],
                               texture2d_array<half, access::write> outTexture
                               [[texture(1)]],
                               const device half4 *alpha [[buffer(0)]],
...
kernel void prelu_other_half(texture2d_array<half, access::sample> inTexture
                             [[texture(0)]],
                             texture2d_array<half, access::write> outTexture
                             [[texture(1)]],

...
kernel void buffer_to_texture_array_kernel_half(const device float *input [[buffer(0)]],
...
kernel void buffer_to_texture_array_kernel_half_channel_3(const device float *input [[buffer(0)]],
                                                    texture2d_array<half, access::write> outTexture [[texture(0)]],
                                                    uint3 gid [[thread_position_in_grid]]){
    if (gid.x >= outTexture.get_width() ||
        gid.y >= outTexture.get_height()) {
...
kernel void buffer_to_texture_array_n_channel_kernel_half(const device float *input [[buffer(0)]],
                                          texture2d_array<half, access::write> outTexture [[texture(0)]],
                                          uint3 gid [[thread_position_in_grid]]){
    if (gid.x >= outTexture.get_width() ||
        gid.y >= outTexture.get_height() ||

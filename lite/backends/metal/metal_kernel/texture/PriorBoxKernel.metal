...
kernel void prior_box(texture2d_array<float, access::read> inTexture
                      [[texture(0)]],
                      texture2d_array<float, access::write> outBoxTexture
                      [[texture(1)]],
                      texture2d_array<float, access::write> varianceTexture
                      [[texture(2)]],
...
kernel void prior_box_half(texture2d_array<half, access::read> inTexture
                           [[texture(0)]],
                           texture2d_array<half, access::write> outBoxTexture
                           [[texture(1)]],
                           texture2d_array<half, access::write> varianceTexture
                           [[texture(2)]],

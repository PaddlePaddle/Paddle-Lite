...
kernel void conv_1x1(texture2d_array<ftype, access::sample> inTexture
                     [[texture(0)]],
                     texture2d_array<ftype, access::sample> biasTexture
                     [[texture(1)]],
...
kernel void conv_3x3(texture2d_array<ftype, access::sample> inTexture
                     [[texture(0)]],
                     texture2d_array<ftype, access::sample> biasTexture
                     [[texture(1)]],
                     texture2d_array<ftype, access::write> outTexture
...
kernel void conv_7x7(texture2d_array<ftype, access::sample> inTexture
                     [[texture(0)]],
                     texture2d_array<ftype, access::sample> biasTexture
                     [[texture(1)]],
                     texture2d_array<ftype, access::write> outTexture
...
kernel void group_conv_3x3(texture2d_array<ftype, access::sample> inTexture
                           [[texture(0)]],
                           texture2d_array<ftype, access::sample> biasTexture
                           [[texture(1)]],
                           texture2d_array<ftype, access::write> outTexture
...
kernel void conv_2x2(texture2d_array<ftype, access::sample> inTexture
                     [[texture(0)]],
                     texture2d_array<ftype, access::sample> biasTexture
                     [[texture(1)]],
                     texture2d_array<ftype, access::write> outTexture
...
kernel void conv_1x5(texture2d_array<ftype, access::sample> inTexture
                     [[texture(0)]],
                     texture2d_array<ftype, access::sample> biasTexture
                     [[texture(1)]],
                     texture2d_array<ftype, access::write> outTexture
...
kernel void depthwise_conv_3x3(
  ...
  inputs[1] = inTexture.sample(
      sample, float2(posInInput.x, posInInput.y - dilation_y), output_slice);
  inputs[2] = inTexture.sample(
      sample,
      float2(posInInput.x + dilation_x, posInInput.y - dilation_y),
      output_slice);
  inputs[3] = inTexture.sample(
      sample, float2(posInInput.x - dilation_x, posInInput.y), output_slice);
...
kernel void depthwise_conv_5x5(
    texture2d_array<ftype, access::sample> inTexture [[texture(0)]],
    texture2d_array<ftype, access::sample> biasTexture [[texture(1)]],
    texture2d_array<ftype, access::write> outTexture [[texture(2)]],
    constant MetalConvParam &param [[buffer(0)]],
  ...
  for (int i = 0; i < 5; i++) {
    for (int j = 0; j < 5; j++) {
      ftype4 input =
          inTexture.sample(sample,
                           float2(posInInput.x + j - 2, posInInput.y + i - 2),
                           output_slice);
...
kernel void conv_1x1_quadruple(texture2d_array<half, access::sample> inTexture
                               [[texture(0)]],
...
kernel void conv_3x3_winograd(texture2d_array<half, access::sample> inTexture
                              [[texture(0)]],
                              texture2d_array<half, access::sample> biasTexture
                              [[texture(1)]],
                              texture2d_array<half, access::write> outTexture
  ...
  if (param.hasAddOp == 1) {
    ...
    output[3] =
        get_bias(uint3(tx + 1, ty + 1, tc), param.addParam, biasTexture);
  }

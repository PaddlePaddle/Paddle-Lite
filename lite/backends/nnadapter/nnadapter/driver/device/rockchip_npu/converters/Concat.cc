...
#include "driver/device/rockchip_npu/converter.h"
...
int Program::ConvertConcat(Operation* operation) {
  ...
  graph_->AddOperator(
      rk::nn::OperatorType::CONCAT, input_tensors, output_tensors, &attr);

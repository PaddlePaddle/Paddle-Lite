...
get_filename_component(VAR "${NNADAPTER_HUAWEI_ASCEND_NPU_SDK_ROOT}" REALPATH)
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_SDK_ROOT_REALPATH: ${VAR}")
...
if(CANN_VERSION_ALL_LIST_LENGTH MATCHES "3")
	list(GET CANN_VERSION_ALL_LIST 0 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MAJOR_VERSION)
	list(GET CANN_VERSION_ALL_LIST 1 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MINOR_VERSION)
	list(GET CANN_VERSION_ALL_LIST 2 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_PATCH_VERSION)
	set(NNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION 0)
elseif(CANN_VERSION_ALL_LIST_LENGTH MATCHES "4")
	list(GET CANN_VERSION_ALL_LIST 0 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MAJOR_VERSION)
	list(GET CANN_VERSION_ALL_LIST 1 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MINOR_VERSION)
	list(GET CANN_VERSION_ALL_LIST 2 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_PATCH_VERSION)
	list(GET CANN_VERSION_ALL_LIST 3 NNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION)
else()
  message(FATAL_ERROR "The installation path of Huawei Ascend NPU CANN is wrong: ${NNADAPTER_HUAWEI_ASCEND_NPU_SDK_ROOT}")
endif()
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MAJOR_VERSION: ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MAJOR_VERSION}")
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MINOR_VERSION: ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MINOR_VERSION}")
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_PATCH_VERSION: ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_PATCH_VERSION}")
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION: ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION}")
add_definitions(-DNNADAPTER_HUAWEI_ASCEND_NPU_CANN_MAJOR_VERSION=${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MAJOR_VERSION})
add_definitions(-DNNADAPTER_HUAWEI_ASCEND_NPU_CANN_MINOR_VERSION=${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_MINOR_VERSION})
add_definitions(-DNNADAPTER_HUAWEI_ASCEND_NPU_CANN_PATCH_VERSION=${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_PATCH_VERSION})
add_definitions(-DNNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION=${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION})

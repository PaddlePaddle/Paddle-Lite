...
if(NOT DEFINED NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT)
  set(NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT $ENV{NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT})
  if(NOT NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT)
    message(FATAL_ERROR "Must set NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT or env NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT when NNADAPTER_WITH_HUAWEI_ASCEND_NPU=ON")
  endif()
endif()

message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT: ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}")
...
get_filename_component(VAR "${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}" REALPATH)
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT_REALPATH: ${VAR}")
string(REGEX MATCHALL "[0-9]+" CANN_VERSION_ALL_LIST "${VAR}")
...
elseif(CANN_VERSION_ALL_LIST_LENGTH MATCHES "4")
  ...
  message(FATAL_ERROR "The installation path of Huawei Ascend NPU CANN is wrong: ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}")
endif()
...
message(STATUS "NNADAPTER_HUAWEI_ASCEND_NPU_CANN_BUGFIX_VERSION: ${CANN_BUGFIX_VERSION}")
add_definitions(-DCANN_MAJOR_VERSION=${CANN_MAJOR_VERSION})
add_definitions(-DCANN_MINOR_VERSION=${CANN_MINOR_VERSION})
add_definitions(-DCANN_PATCH_VERSION=${CANN_PATCH_VERSION})
add_definitions(-DCANN_BUGFIX_VERSION=${CANN_BUGFIX_VERSION})

include_directories("${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/acllib/include")
include_directories("${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/include")
include_directories("${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/opp")

# ACL libraries
# libascendcl.so 
find_library(HUAWEI_ASCEND_NPU_SDK_ACL_ASCENDCL_FILE NAMES ascendcl
  PATHS ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/acllib/lib64
  CMAKE_FIND_ROOT_PATH_BOTH)
if(NOT HUAWEI_ASCEND_NPU_SDK_ACL_ASCENDCL_FILE)
  message(FATAL_ERROR "Missing libascendcl.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/acllib/lib64")
endif()
...
if(NOT HUAWEI_ASCEND_NPU_SDK_ACL_RUNTIME_FILE)
  message(FATAL_ERROR "Missing libruntime.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/acllib/lib64")
endif()
...
find_library(HUAWEI_ASCEND_NPU_SDK_ATC_REGISTER_FILE NAMES register
  PATHS ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64
  CMAKE_FIND_ROOT_PATH_BOTH)
if(NOT HUAWEI_ASCEND_NPU_SDK_ATC_REGISTER_FILE)
  message(FATAL_ERROR "Missing libregister.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64")
endif()
...
if(NOT HUAWEI_ASCEND_NPU_SDK_ATC_ASCEND_PROTOBUF_FILE)
  message(FATAL_ERROR "Missing libascend_protobuf.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64")
endif()
...
if(NOT HUAWEI_ASCEND_NPU_SDK_ATC_GRAPH_FILE)
  message(FATAL_ERROR "Missing libgraph.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64")
endif()
...
if(NOT HUAWEI_ASCEND_NPU_SDK_ATC_GE_COMPILER_FILE)
  message(FATAL_ERROR "Missing libge_compiler.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64")
endif()
...
if(NOT HUAWEI_ASCEND_NPU_SDK_ATC_GE_COMMON_FILE)
  message(FATAL_ERROR "Missing libge_common.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64")
endif()
...
if(NOT HUAWEI_ASCEND_NPU_SDK_ATC_RESOURCE_FILE)
  message(FATAL_ERROR "Missing libresource.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/atc/lib64")
endif()
...
find_library(HUAWEI_ASCEND_NPU_SDK_OPP_OPSPROTO_FILE NAMES opsproto
  PATHS ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/opp/op_proto/built-in
  CMAKE_FIND_ROOT_PATH_BOTH)
if(NOT HUAWEI_ASCEND_NPU_SDK_OPP_OPSPROTO_FILE)
  message(FATAL_ERROR "Missing libopsproto.so in ${NNADAPTER_HUAWEI_ASCEND_NPU_CANN_SDK_ROOT}/opp/op_proto/built-in")
endif()

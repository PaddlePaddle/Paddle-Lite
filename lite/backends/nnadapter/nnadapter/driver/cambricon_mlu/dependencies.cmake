...
find_library(CAMBRICON_MLU_SDK_MAGICMIND_FILE NAMES magicmind_core
  PATHS ${NNADAPTER_CAMBRICON_MLU_SDK_ROOT}/${CAMBRICON_MLU_SDK_SUB_LIB_PATH}
  CMAKE_FIND_ROOT_PATH_BOTH)
if(NOT CAMBRICON_MLU_SDK_MAGICMIND_FILE)
    message(FATAL_ERROR "Missing magicmind in ${NNADAPTER_CAMBRICON_MLU_SDK_ROOT}/${CAMBRICON_MLU_SDK_SUB_LIB_PATH}")
endif()
add_library(magicmind_core SHARED IMPORTED GLOBAL)
set_property(TARGET magicmind_core PROPERTY IMPORTED_LOCATION ${CAMBRICON_MLU_SDK_MAGICMIND_FILE})

set(${DEVICE_NAME}_deps magicmind_core)

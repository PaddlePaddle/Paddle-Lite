...
static bool NeedInsertQuant(hal::Model* model, hal::Operand* operand) {
...
static bool NeedDeleteDequant(hal::Model* model, hal::Operand* operand) {
...
static hal::Operand* DelDequantOperation(hal::Model* model,
...
static void InsertQuant(hal::Model* model) {
...
static void DeleteDequant(hal::Model* model) {
  std::vector<NNAdapterOperationCode> valid_quant_ops_type{
      NNADAPTER_CONV_2D, NNADAPTER_FULLY_CONNECTED};
  std::vector<hal::Operation*> operations =
      SortOperationsInTopologicalOrder(model);
...
static void ChangeQuantizedOpOutPrecision(hal::Model* model) {
  std::vector<NNAdapterOperationCode> valid_quant_ops_type{
      NNADAPTER_CONV_2D, NNADAPTER_FULLY_CONNECTED};
  std::vector<hal::Operation*> operations =
      SortOperationsInTopologicalOrder(model);

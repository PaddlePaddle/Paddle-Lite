...
#include "driver/optimizer/symm2asymm.h"
#include <vector>
...
static void ConvertOperandFromSymmToAsymm(Operand* operand,
                                          int32_t zero_point) {
...
NNADAPTER_EXPORT void ConvertModelFromSymmToAsymmQuantization(Model* model) {

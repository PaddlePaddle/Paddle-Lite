...
#include "driver/optimizer/nchw2nhwc.h"
#include <vector>
...
static void InsertNCHWToNHWCConversionToInputsOutputs(Model* model) {
...
inline bool IsOperandConvertToNHWC(Operand* operand) {
  return operand->type.layout == NNADAPTER_NHWC;
}

inline bool MarkOperandConvertToNHWC(Operand* operand) {
  return operand->type.layout = NNADAPTER_NHWC;
}

static void ConvertPool2DFromNCHWToNHWC(Operation* operation) {
...
static void ConvertActivationFromNCHWToNHWC(Operation* operation) {
  auto& input_operands = operation->input_operands;
  auto& output_operands = operation->output_operands;
  auto input_count = input_operands.size();
  auto output_count = output_operands.size();
...
static void ConvertElementwiseFromNCHWToNHWC(Operation* operation) {
  auto& input_operands = operation->input_operands;
  auto& output_operands = operation->output_operands;
  auto input_count = input_operands.size();
  auto output_count = output_operands.size();
...
static void ConvertSoftmaxFromNCHWToNHWC(Operation* operation) {
  auto& input_operands = operation->input_operands;
  auto& output_operands = operation->output_operands;
  auto input_count = input_operands.size();
  auto output_count = output_operands.size();
...
static void ConvertFullyConnectedFromNCHWToNHWC(Operation* operation) {
  auto& input_operands = operation->input_operands;
  auto& output_operands = operation->output_operands;
  auto input_count = input_operands.size();
  auto output_count = output_operands.size();
...
static void ConvertConv2DFromNCHWToNHWC(Operation* operation) {
  auto& input_operands = operation->input_operands;
  auto& output_operands = operation->output_operands;
  auto input_count = input_operands.size();
  auto output_count = output_operands.size();
...
NNADAPTER_EXPORT void ConvertModelFromNCHWToNHWCDataLayout(Model* model) {

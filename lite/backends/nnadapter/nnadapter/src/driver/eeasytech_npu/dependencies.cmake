...
#target_link_libraries(${NNADAPTER_EEASYTECH_NPU_SDK_ROOT}/${EEASYTECH_NPU_SDK_SUB_LIB_PATH} -leznpu_ddk)
#find_library(${NNADAPTER_EEASYTECH_NPU_SDK_ROOT}/${EEASYTECH_NPU_SDK_SUB_LIB_PATH}/ -leznpu_ddk)
#add_library(eznpu_ddk SHARED IMPORTED GLOBAL)
#add_library(eznpu_ddk STATIC IMPORTED GLOBAL)

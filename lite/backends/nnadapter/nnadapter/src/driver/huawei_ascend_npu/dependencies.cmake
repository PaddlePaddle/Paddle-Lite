...
macro(find_huawei_ascend_npu_sdk_version huawei_ascend_npu_sdk_version_info) 
    ...
    if(NOT HUAWEI_ASCEND_NPU_SDK_VERSION)
        message(FATAL_ERROR "Failed to extract the CANN version, please set the correct NNADAPTER_HUAWEI_ASCEND_NPU_SDK_ROOT or manually set NNADAPTER_HUAWEI_ASCEND_NPU_SDK_VERSION as NNADAPTER_HUAWEI_ASCEND_NPU_SDK_VERSION=6.0.0")
    else()

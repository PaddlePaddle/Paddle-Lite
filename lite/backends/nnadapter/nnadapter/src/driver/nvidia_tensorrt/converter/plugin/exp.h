...
class ExpPluginDynamic : public PluginDynamic {
 public:
  ExpPluginDynamic() = default;

  ExpPluginDynamic(const void* serial_data, size_t serial_length) {}

  nvinfer1::IPluginV2DynamicExt* clone() const noexcept {
    return new ExpPluginDynamic;
  }
...
class ExpPluginDynamicCreator : public PluginCreator {
 public:

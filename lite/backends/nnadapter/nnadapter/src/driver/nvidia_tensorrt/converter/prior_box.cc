...
int ConvertPriorBox(Converter* converter, core::Operation* operation) {
  ...
  std::vector<int32_t> input_dimension_vec(input_dimension, input_dimension + 4);
  std::vector<int32_t> image_dimension_vec(image_dimension, image_dimension + 4);     
  ...
  std::vector<float> aspect_ratios(aspect_ratios_data, aspect_ratios_data + aspect_ratios_size);  
  ...
  PriorBoxPluginDynamic prior_box_plugin(aspect_ratios, input_dimension_vec,
                            image_dimension_vec, *reinterpret_cast<float*>(step_w_operand->buffer), *reinterpret_cast<float*>(step_h_operand->buffer), min_sizes,
                            max_sizes, *reinterpret_cast<float*>(offset_operand->buffer), *reinterpret_cast<bool*>(clip_operand->buffer), *reinterpret_cast<bool*>(flip_operand->buffer),
                            *reinterpret_cast<bool*>(min_max_aspect_ratios_order_operand->buffer), variances);       

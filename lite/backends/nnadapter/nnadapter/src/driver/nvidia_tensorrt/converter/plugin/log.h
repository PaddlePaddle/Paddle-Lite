...
class LogPluginDynamic : public PluginDynamic {
 public:
  LogPluginDynamic() = default;

  LogPluginDynamic(const void* serial_data, size_t serial_length) {}

  nvinfer1::IPluginV2DynamicExt* clone() const noexcept {
    return new LogPluginDynamic;
  }
...
class LogPluginDynamicCreator : public PluginCreator {
 public:

...
macro(add_xtcl_lib_deps LIB_PATH)
  ...
  set(LIB_TYPE STATIC)
  if(${LIB_EXT} STREQUAL ".so" OR ${LIB_EXT} STREQUAL ".so.1")
    set(LIB_TYPE SHARED)
  endif()
...
if(NNADAPTER_KUNLUNXIN_XTCL_SDK_ROOT)
  ...
  if(MSVC)
    ...
    add_xtcl_lib_deps(${NNADAPTER_KUNLUNXIN_XTCL_SDK_ROOT}/XTCL/runtime/shlib/libxpurt.so.1)
  ...
  if(NOT NNADAPTER_KUNLUNXIN_XTCL_SDK_URL)
    set(NNADAPTER_KUNLUNXIN_XTCL_SDK_URL "http://baidu-kunlun-product.su.bcebos.com/KL-SDK/klsdk-dev/20221201")
  endif()
  if(NOT NNADAPTER_KUNLUNXIN_XTCL_SDK_ENV)
  ...
  if(MSVC)
    ...
    add_xtcl_lib_deps(${NNADAPTER_KUNLUNXIN_XTCL_SDK_INSTALL_DIR}/xre/so/libxpurt.so.1 DEPS xre)

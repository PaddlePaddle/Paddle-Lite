...
class Converter {
 public:
  explicit Converter(xtcl::network::xNetworkBuilder* builder,
                     ...
                     std::map<core::Operand*, std::vector<xtcl::xExpr>>* exprs)
  ...
  xtcl::xExpr ConvertOperand(core::Operand* operand,
 ...
 private:
  ...
  std::map<core::Operand*, std::vector<xtcl::xExpr>>* exprs_{nullptr};

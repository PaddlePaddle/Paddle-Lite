...
REGISTER_OPERATION(FILL_LIKE, PrepareFillLike)
...
REGISTER_OPERATION(YOLO_BOX_HEAD, PrepareYoloBoxHead)
// REGISTER_OPERATION(YOLO_BOX_PARSER, PrepareYoloBoxParser)
#endif  // NOLINT

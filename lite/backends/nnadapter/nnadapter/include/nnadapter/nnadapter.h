...
typedef enum {
  ...
  */
   ...
   *        confidence predictions. N is the batch size, C is the class number,
   *        M is number of bounding boxes.
   ...
   *        case with shape [N, M, 4/8/16/24/32].
   *     2. A 2-D LoDTensor with shape [M, C]. M is the number of bbox, C is
   *        the class number. In this case, input bboxes should be the second

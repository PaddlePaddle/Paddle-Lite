...
struct PMNode {
  ...
  PMNode* AsOp(NNAdapterOperationType op_type) {
    type_ = Type::kOp;
    assert_is_op(op_type);
    return this;
  }

  void set_op_type(NNAdapterOperationType op_type) { op_type_ = op_type; }
  ...
  PMNode* assert_is_op();
  PMNode* assert_is_op(NNAdapterOperationType op_type);
  PMNode* assert_is_not_op_type(NNAdapterOperationType op_type);
 ...
 private:
  ...
  PMPattern* pattern_;
  std::string name_;
  NNAdapterOperationType op_type_;
  Type type_{};

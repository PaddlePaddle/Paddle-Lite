...
class EmbSeqPoolCreator : public JitCodeCreator<emb_seq_pool_attr_t> {
 public:
  ...
  std::unique_ptr<GenBase> CreateJitCode(
    ...
    PADDLELITE_ENFORCE_GT(attr.table_height, 0);
    PADDLELITE_ENFORCE_GT(attr.table_width, 0);
    PADDLELITE_ENFORCE_GT(attr.index_height, 0);
    PADDLELITE_ENFORCE_GT(attr.index_width, 0);
    PADDLELITE_ENFORCE_GT(attr.out_width, 0);

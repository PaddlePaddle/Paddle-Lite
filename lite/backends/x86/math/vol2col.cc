...
class Vol2ColFunctor<lite::TargetType::kX86, T> {
 public:
  void operator()(const lite::X86Context& context,
    ...
    PADDLELITE_ENFORCE(vol.dims().size() == 4);
    PADDLELITE_ENFORCE(col->dims().size() == 7);
    ...
    PADDLELITE_ENFORCE_EQ((input_depth + 2 * paddings[0] -
                          ...
                          "mismatching.");
    PADDLELITE_ENFORCE_EQ((input_height + 2 * paddings[1] -
                          ...
                          "mismatching.");
    PADDLELITE_ENFORCE_EQ((input_width + 2 * paddings[2] -

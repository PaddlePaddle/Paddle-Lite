...
template <typename T>
void elementwise_add_relu_scale(const T* dinx, const T* diny, T* dout, int num, float scale);
...
template <typename T>
void elementwise_add_relu_scale_broadcast(
    const T* dinx, const T* diny, T* dout, int batch, int channels, int num, float scale);

...
#include "lite/core/mir/fusion/elementwise_add_scale_fuse_pass.h"
#include <memory>
#include <vector>
#include "lite/core/mir/fusion/elementwise_add_scale_fuser.h"
...
void ElementwiseScaleFusePass::Apply(const std::unique_ptr<SSAGraph>& graph) {
  ...
  std::vector<std::string> elt_types{"elementwise_mul"};

...
#include "lite/core/optimizer/mir/fusion/squeeze2_matmul_fuse_pass.h"
#include <memory>
#include <vector>
...
REGISTER_MIR_PASS(lite_squeeze2_matmul_fuse_pass,
                  paddle::lite::mir::Squeeze2MatmulFusePass)

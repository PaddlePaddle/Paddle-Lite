...
#include "lite/core/mir/fusion/instance_norm_activation_fuse_pass.h"
#include <memory>
#include <vector>
#include "lite/core/mir/fusion/instance_norm_activation_fuser.h"
...
void InstanceNormActivationFusePass::Apply(
  ...
  for (auto act_type : {"relu", "relu6", "leaky_relu"}) {
    fusion::InstanceNormActivationFuser fuser(act_type);
    fuser(graph.get());
  }
}

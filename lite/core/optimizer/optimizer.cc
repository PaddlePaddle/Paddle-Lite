...
std::unique_ptr<RuntimeProgram> RunDefaultOptimizer(
  ...
  std::vector<std::string> passes_local{
      {"lite_quant_dequant_fuse_pass",
       ...
       "__xpu__qk_attention_fuse_pass",
       "__xpu__qk_v_attention_fuse_pass",
       "__xpu__mask_pruning_fuse_pass",
       "__xpu__encoder_fuse_pass",
       "__xpu__encoder_adaptive_seqlen_fuse_pass",
       "__xpu__multiple_encoder_fuse_pass",
       "__xpu__token_scatter_fuse_pass",
       "__xpu__embedding_unpad_fuse_pass",

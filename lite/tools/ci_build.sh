...
function test_arm_android {
    ...
    skip_list=("test_model_parser" "test_mobilenetv1" "test_mobilenetv2" "test_resnet50" "test_inceptionv4" "test_light_api" "test_apis" "test_paddle_api" "test_cxx_api" "test_gen_code" "test_mobilenetv1_int8" "test_subgraph_pass" "test_grid_sampler_image_opencl" "test_lrn_image_opencl" "test_pad2d_image_opencl" "test_transformer_with_mask_fp32_arm" "test_fast_rcnn" "test_inception_v4_fp32_arm" "test_mobilenet_v1_fp32_arm" "test_mobilenet_v2_fp32_arm" "test_mobilenet_v3_small_x1_0_fp32_arm" "test_mobilenet_v3_large_x1_0_fp32_arm" "test_resnet50_fp32_arm" "test_squeezenet_fp32_arm" "test_mobilenet_v1_int8_arm" "test_mobilenet_v2_int8_arm" "test_resnet50_int8_arm")
    for skip_name in ${skip_list[@]} ; do

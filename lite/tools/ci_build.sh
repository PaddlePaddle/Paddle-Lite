...
function test_arm_android {
    ...
    skip_list=("test_model_parser" "test_mobilenetv1" "test_mobilenetv2" "test_resnet50" "test_inceptionv4" "test_light_api" "test_apis" "test_paddle_api" "test_cxx_api" "test_gen_code" "test_mobilenetv1_int8" "test_subgraph_pass" "test_grid_sampler_image_opencl" "test_lrn_image_opencl" "test_pad2d_image_opencl" "test_transformer_with_mask_fp32")
    for skip_name in ${skip_list[@]} ; do
    ...
    for i in "$@"; do
        case $i in
            ...
            build_test_arm_subtask_android)
                ...
                build_test_arm_subtask_model test_transformer_with_mask_fp32 transformer_with_mask_fp32
                shift
                ;;
            build_test_arm_subtask_armlinux)
                build_test_arm_subtask_armlinux

...
WITH_LOG=ON
# controls whether to throw the exception when error occurs, default is ON
WITH_EXCEPTION=ON
...
function print_usage {
    ...
    echo -e "|     ./lite/tools/build_xcode.sh                                                                                                        |"
    echo -e "|  compile iOS armv7 library:                                                                                                          |"
    echo -e "|     ./lite/tools/build_xcode.sh  --arch=armv7                                                                                          |"
    echo -e "|  print help information:                                                                                                             |"
    echo -e "|     ./lite/tools/build_xcode.sh help                                                                                                   |"
    echo -e "|                                                                                                                                      |"

...
NNADAPTER_HUAWEI_ASCEND_NPU_OF_MDC=OFF
NNADAPTER_HUAWEI_ASCEND_NPU_EXECUTE_ONLY=OFF
...
function init_cmake_mutable_options {
    ...
    cmake_mutable_options="-DLITE_WITH_ARM=$with_arm \
                        ...
                        -DNNADAPTER_HUAWEI_ASCEND_NPU_OF_MDC=$NNADAPTER_HUAWEI_ASCEND_NPU_OF_MDC \
                        -DNNADAPTER_HUAWEI_ASCEND_NPU_EXECUTE_ONLY=$NNADAPTER_HUAWEI_ASCEND_NPU_EXECUTE_ONLY \
    ...
    for i in "$@"; do
        case $i in
            ...
            --nnadapter_huawei_ascend_npu_sdk_version=*)
                ...
                shift
                ;;
            --nnadapter_huawei_ascend_npu_execute_only=*)
                NNADAPTER_HUAWEI_ASCEND_NPU_EXECUTE_ONLY="${i#*=}"
                shift
                ;;
            --nnadapter_huawei_ascend_npu_of_mdc=*)
                NNADAPTER_HUAWEI_ASCEND_NPU_OF_MDC="${i#*=}"
                shift
                ;;
